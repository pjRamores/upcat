    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                }).response?.data?.error || "Could not load results";
                setError(msg);
            } finally {
    ...
    <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        {score.rawScore !== undefined && (
            <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-2 text-center text-sm text-slate-700">{score.correct} correct
                    + {score.incorrect} incorrect + {score.unanswered} unanswered = <span
                        className="font-semibold">{score.rawScore} points</span></p>
            </div>
        )}
        {/* Summary cards */}
