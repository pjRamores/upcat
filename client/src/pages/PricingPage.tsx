...
export default function PricingPage() {
    ...
    return (
        <div className="mx-auto max-w-6xl px-4 py-10">
            ...
            <header className="mb-8 rounded-2xl bg-gradient-to-r from-rose-900 via-rose-800 to-orange-700 p-8 text-white">
            ...
            {isFreeMode ? (
                ...
                <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    {plans.map((plan) => (
                        <article key={plan.id} className={plan.isPopular ? "border-primary-500 ring-2 ring-primary-200" : "border-slate-200"}>
                            {plan.isPopular && (
                                <span className="absolute -top-3 right-4 rounded-full bg-primary-600 px-2 py-1 text-[10px] font-bold uppercase tracking-wide text-white">
                                    Most Popular
                                </span>
                            )}
