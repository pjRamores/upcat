...
export default function SubjectReadingPage() {
    return (
        <SubjectPage
            ...
            intro="UPCAT reading passages are dense and the questions reward inference, not lookup. Build endurance with full-length passages and train your eye to spot the author's purpose, tone, and structural cues."
            topics={[
            ...
            sampleQuestion={{
                prompt: "In the sentence 'Although the storm had passed, an uneasy silence lingered over the village,' the word 'lingered' most nearly means:",
                choices: [
                ...
                answerLetter: "B",
                explanation: "To linger means to stay or remain longer than expected. The contrast with the storm passing reinforces that the silence persisted.",
            }}
