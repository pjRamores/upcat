  ...
  return (
    <SubjectPage
      ...
      sampleQuestion={{
        ...
        answerLetter: "B",
        explanation:
          "Parallel·structure·requires·consistent·grammatical·form.·All·three·items·in·B·are·gerunds·(-ing·forms).",
        }}
      practiceCtaRef="/practice?subject=Language%20Proficiency"
    </>
  );
}