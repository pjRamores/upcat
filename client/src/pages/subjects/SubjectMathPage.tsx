...
export default function SubjectMathPage() {
    return (
        <SubjectPage
            ...
            intro="Sharpen the math skills the UPCAT actually tests. Every question on UPCAT Simulator is hand-written to mirror the difficulty curve of the real exam, with detailed step-by-step explanations so you understand the why behind each answer."
            topics={[
            ...
            sampleQuestion={{
                ...
                answerLetter: "B",
                explanation: "Substitute x = 2: f(2) = 3(2)² - 2(2) + 5 = 12 - 4 + 5 = 13.",
            }}
