...
export default function SubjectSciencePage() {
    return (
        <SubjectPage
            ...
            intro="Cover every branch of the UPCAT Science subtest. Our question bank emphasizes the scenario-style problems UP favors — interpret a chart, + predict an outcome, apply a concept — not just rote recall."
            topics={[
            ...
            sampleQuestion={{
                prompt: "Which of the following best describes the role of mitochondria in a eukaryotic cell?",
                choices: [
                ...
                answerLetter: "B",
                explanation: "Mitochondria generate most of a cell's ATP through oxidative phosphorylation, the final stage of aerobic respiration.",
            }}
            practiceCtaHref="/practice?subject=Science"
        />
    );
}