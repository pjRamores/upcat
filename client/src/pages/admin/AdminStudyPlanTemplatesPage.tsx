...
import { studyPlanAdminApi, setTemplates } from "@lib/studyPlanApi";
        ...
        <div className="space-y-4">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4">
                ...
                <div className="mt-2 flex gap-2">
                    <input value={name} onChange={(e) => setName(e.target.value)} className="flex-1 rounded border border-slate-300 px-3 py-2 text-sm" placeholder="Template name"/>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4">
                <table className="w-full text-left text-sm">
                    ...
                    <tbody>
                        {templates.map((t) => (
                            <tr key={t.id ?? t.id} className="border-t border-slate-100">
