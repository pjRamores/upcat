...
<className="rounded-md border border-primary-300 px-3 py-1.5 text-xs font-medium text-primary-700 hover:bg-primary-50 disabled:opacity-40">
Deactivate
</button>
) : (
...
<className="rounded-md border border-slate-200 px-3 py-1.5 text-xs font-medium text-emerald-700 hover:bg-slate-50">
Verify email
</button>
) }
...
<form
className="space-y-3 rounded-xl border border-slate-200 bg-white p-5 shadow-sm lg:col-span-2"
onSubmit={(e) => {
e.preventDefault();
