    ...
    <div className="space-y-4">
        <section className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            ...
            <p className="mt-2 text-xs text-amber-700">
                ...
                <code className="rounded bg-white px-1 py-0.5">client/public/data/seo-overrides.json</code>, then rebuild and redeploy.
            </p>
        </section>
...
<input type="checkbox" checked={noIndex} onChange={(e) => setNoIndex(e.target.checked)}/><span>Hide from search engines (noindex) and from sitemap</span>
</label>
