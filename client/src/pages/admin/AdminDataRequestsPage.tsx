                ...
                <table className="min-w-full text-sm">
                    <thead className="bg-gray-50 text-left uppercase tracking-wide text-gray-500">
                        <tr>
                            ...
                            {type === "deletion" && <th className="px-3 py-2">Scheduled</th>}
                            {type === "export" && <th className="px-3 py-2">Expires</th>}
                    ...
                    <tbody>
                        {requests.map((r) => (
                            <tr key={r.id} className="border-t border-gray-100 hover:bg-gray-50">
                                ...
                                <Link to={`/admin/users/${r.userId}`} className="text-xs text-primary-700 hover:underline">
                                    {r.userId}
                                </Link>
                                ...
                                {type === "deletion" && (
                                    <td className="px-3 py-2 text-xs text-gray-500">
                                        {r.deletion?.scheduledFor ? new Date(r.deletion.scheduledFor).toLocaleString() : "-"}
                                    </td>
                                )}
                                {type === "export" && (
                                    <td className="px-3 py-2 text-xs text-gray-500">
                                        {r.export?.expiresAt ? new Date(r.export.expiresAt).toLocaleString() : "-"}
                                    </td>
                                )}
