                ...
                {data.items.map((t) => {
                    ...
                    return (
                        <tr key={t._id} className="border-t border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="px-3 py-2 text-xs">{SUPPORT_TICKET_TYPE_META[t.type]?.label}</td>
                            ...
                            <td className="px-3 py-2">{t.requesterEmail}</td>
...
function renderComponent<T>(component: T): JSX.Element {
    return (
        <div>
            {component}
        </div>
