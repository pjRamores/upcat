...
export default function AdminUserNewPage() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-slate-500">A random password is generated. Toggle "Send invite" to email a reset
      link instead.</p>
      <div className="grid grid-cols-2 gap-3">
        <Field label="First name"><input name="firstName" required
          className="w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"></Field>
        <Field label="Last name"><input name="lastName" required
          className="w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"></Field>
      </div>
      <Field label="Email"><input name="email" type="email" required
          className="w-full rounded-md border border-slate-300 px-2 py-1.5 text-sm"></Field>
      <Field label="Role">
        <select name="role" defaultValue="reviewee"
