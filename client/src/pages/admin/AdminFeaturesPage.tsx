            ...
            <div className="mt-4 space-y-4 border-t border-slate-200 pt-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingData((prev) => {
                    return { ...prev, freeLimit: e.target.value };
                  })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingData((prev) => {
                    return { ...prev, premiumLimit: e.target.value };
                  })}
                  className="mt-1 w-full rounded border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"
                  placeholder="Enter limit or leave blank for unlimited"
                />
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setEditingData((prev) => {
                    return { ...prev, limitPeriod: (e.target.value || "") as FeatureEditState["limitPeriod"], };
                  })}
                  className="mt-1 w-full rounded border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"
                >
