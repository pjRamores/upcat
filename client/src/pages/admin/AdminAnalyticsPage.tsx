      ...
      <div className="flex flex-wrap items-center gap-2">
        {(["week", "month", "year", "all"] as Period[]).map((p) => (
          <button
            ...
            type="button"
            onClick={() => setPeriod(p)}
            className={`rounded-full border px-3 py-1.5 text-xs font-medium ${period === p ? "border-primary-600 bg-primary-600 text-white" : "border-slate-200 bg-white text-slate-700 hover:bg-slate-50"}`}
          >
