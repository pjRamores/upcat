...
This code snippet is a TypeScript function that updates a manual channel in a React application. It uses the `setManualChannel` function to set the channel ID and the `setManualConfig` function to configure the manual channel. The `setSavingManual` function is used to save the manual channel to the database. The `setPangConfig` function is used to save the PangMeryenda configuration to the database. The `testPangConnection` function is used to test the PangMeryenda connection. The `if (loading)` function is used to check if the application is loading. The `return` function is used to return the result of the `setManualChannel` function.
...
{activePaymentType === "pangmeryenda" && pangConfig && (
  <section className="order-4·rounded-x1·border·border-slate-200·bg-white·p-5·shadow-sm">
    <h2 className="text-lg·font-sembold·text-slate-900">PangMeryenda·Settings</h2>
    <p className="mt-1·text-sm·text-slate-600">
    ...
    <form onSubmit={savePangConfig} className="mt-4·space-y-4">
      <div className="grid·gap-3·md:grid-cols-2">
        <label className="block">
          <span className="text-xs·font-sembold·text-slate-700">API·base·URL</span>
          <input
            type="text"
        ...
        <label className="block">
          <span className="text-xs·font-sembold·text-slate-700">Merchant·ID</span>
          <input
            type="text"
        ...
        <label className="block">
          <span className="text-xs·font-sembold·text-slate-700">API·secret (leave·blank to·keep·current)</span>
          <input
            type="password"
            value={pangApiSecret}
            onChange={(e) =>
      ...
      <label className="block">
        <span className="text-xs·font-sembold·text-slate-700">Webhook·secret</span>
        <input
          type="text"
      ...
      <div className="grid·gap-3·md:grid-cols-3">
        <label className="block">
          <span className="text-xs·font-sembold·text-slate-700">Success·redirect·URL</span>
<input
  type="text"
