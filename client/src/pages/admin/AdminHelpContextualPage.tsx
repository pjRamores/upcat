...
export default function AdminHelpContextualPage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2x1 font-bold text-slate-900">Contextual Help Manager</h1>
        <p className="mt-1 text-sm text-slate-600">Define inline help points and attach them to page
        selectors.</p>
      </header>
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                const existing = rows.find((row) => String(row._id) === id);
