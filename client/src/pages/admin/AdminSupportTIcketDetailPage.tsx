 ...
 * Right side: metadata (requester, type, status, priority, assignee, verification, resolution),
 * quick actions (status change, verify identity, unlock account).
 */
...
className="rounded-b-xl border border-gray-200 bg-white p-4 shadow-sm"
>
<textarea
required
rows={3}
