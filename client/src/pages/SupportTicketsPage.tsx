    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-10">
            ...
            {tickets === null ? (
                ...
                <ul
                    className="divide-y divide-gray-100 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm"
                ...
                >
                    {tickets.map((t) => {
                        ...
                        return (
                            <li key={t._id}>
                                <Link to={`/support/${t.ticketNumber}`}>
                                    <div className="min-w-0">
                                        <p className="text-sm font-semibold text-gray-900">{t.ticketNumber}</p>
                                    </div>
                                    <p className="mt-0.5 truncate text-xs text-gray-500">{type.icon} {type.label} · updated{" "}
