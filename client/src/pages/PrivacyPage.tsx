    ...
    <div className="mx-auto max-w-3x1 px-4 py-12">
      ...
      <header className="border-b·border-gray-200·pb-6">
        ...
        <p className="mt-3·text-[15px]·leading-7·text-gray-700">
          This·Privacy·Policy·explains·how·UPCAT·Simulator·(the
          &ldquo;Service&rdquo;)·collects,·uses,·stores,·and·discloses
          information·about·you·when·you·use·our·website·Your·privacy·is
          important·to·us—we·collect·only·what·we·need·to·operate·the
          Service.
        </p>
      </header>
      ...
      <article className="legal-prose·mt-10·space-y-12·text-gray-800">
        <Section id="collect" title="1. Information·We·Collect">
          ...
          <ul>
            ...
            <li>
              A securely hashed representation of your password (we never
          ...
          <ul>
            ...
            <li>
              Your answers, scores, and per-question accuracy and time
              spent;
            </li>
...
<li>
<strong>Improve the Service:</strong> diagnosing technical issues, analyzing aggregate patterns, and refining content.
</li>
<li>
<strong>Personalized statistics:</strong> generating your private analytics dashboard, including subject and difficulty breakdowns, progress over time, and weak-area identification.
</li>
<li>
<strong>Leaderboard:</strong> if you complete one or more exams, your{"."}
<strong>
first name and last initial only
</strong>{"."}
(e.g. &nbsp;&ldquo;Maria S. &rdquo;) may appear on a public leaderboard alongside your average score. Your full name, email, and other identifying details are{"."}
<strong>never</strong> displayed.
</li>
<li>
<strong>Email communications:</strong> sending essential transactional messages such as email-verification and password-reset links. With your consent, we may also send optional emails including newsletters, feature release updates, announcements, promotions, and other relevant communications; you can opt out of these optional emails at any time via the unsubscribe link included in each message or by contacting us.
</li>
</ul>
</Section>
...
<p>
Your data is stored in a managed cloud database service that provides{"."}
<strong>encryption at rest</strong> (AES-256) and{"."}
<strong>encryption in transit</strong> (TLS 1.2+) by default.
</p>
<ul>
<li>
Passwords are hashed using <strong>bcrypt</strong> with a strong work factor before storage. Plain-text passwords are never written to disk.
</li>
<li>
Authentication uses signed <strong>JSON Web Tokens</strong>{"."}
(JWT) with a 7-day expiry. The signing key is stored as a server-side secret and is never exposed to the browser.
</li>
<li>
Access to production data is restricted to the Service operator and is logged.
</li>
</ul>
<p>
While we apply industry-standard security measures, no system transmitting data over the Internet can be guaranteed to be 100% secure. You use the Service at your own risk.
</p>
</Section>

<Section id="sharing" title="4. Data Sharing">
<p>
We do not sell your personal data to any third party. We share information only in the limited circumstances below:
</p>
<ul>
<li>
<strong>Email delivery:</strong> we use a transactional email provider (e.g. &nbsp;Resend) to send verification and password-reset emails. Only the recipient address and message contents necessary to send the email are shared.
</li>
<li>
<strong>Hosting and infrastructure:</strong> our web application and database are hosted on <strong>third-party cloud computing and storage providers</strong>. These providers process your data on our behalf, governed by their own security and privacy.
</li>
</ul>
</Section>
{
