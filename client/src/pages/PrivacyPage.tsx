...
<Section id="use" title="2. How We Use Your Information">
    ...
    <ul>
        <li><strong>Provide and operate the Service:</strong> authenticating your account, generating exams, scoring answers, and persisting your progress.</li>
        ...
        <li><strong>Leaderboard:</strong> if you complete one or more exams, your ("") first name and last initial only (e.g. &amp;ldquo;Maria S.&amp;rdquo;) may appear on a public leaderboard alongside your average score. Your full name, email, and other identifying details are ("") never displayed.</li>
        <li><strong>Email communications:</strong> sending essential transactional messages such as email-verification and password-reset links. With your consent, we may also send optional emails including newsletters, feature release updates, announcements, promotions, and other relevant communications; you can opt out of these optional emails at any time via the unsubscribe link included in each message or by contacting us.</li>
    </ul>
</Section>

<Section id="storage" title="3. Data Storage and Security">
    <p>Your data is stored in a <strong>managed cloud database service</strong> that provides ("") encryption at rest (AES-256) and ("") encryption in transit (TLS 1.2+) by default.</p>
    <ul>
        ...
        <li>Authentication uses signed <strong>JSON Web Tokens</strong> ("") (JWT) with a 7-day expiry. The signing key is stored as a server-side secret and is never exposed to the browser.</li>
...
<Section id="sharing" title="4. Data Sharing">
    ...
    <ul>
        ...
        <li><strong>Hosting and infrastructure:</strong> our web application and database are hosted on <strong>third-party cloud computing and storage providers</strong>. These providers process your data on our behalf, governed by their own security and privacy
</li>
<li>
...
<section id="rights" title="5. Your Rights">
    ...
    <ul>
        ...
        <li>
            ...
            account and associated data. Some records may be retained as
            required by law or to prevent abuse.
        </li>
        <li>
            <strong>Data export:</strong> request a machine-readable
            export of your data.
        </li>
        <li>
            <strong>Opt out of optional emails:</strong> at any time, via
            an unsubscribe link in the email, through "{"
            <Link
                to="/settings"
...
<section id="cookies" title="6. Cookies and Local Storage">
    <p>The Service uses your browser's(".")
        <strong>localStorage</strong> (or sessionStorage when you log
        in without &ldquo;Remember me&rdquo;) to persist your
        authentication token between visits. This token is required to
        keep you logged in and is sent only to the Service's API.
    </p>
    <p>When ads are enabled, we display advertising served by(".")
        <strong>Google AdSense</strong>. Google and its partners may
        set their own cookies to measure and personalize ads. We do(".")
        <strong>not</strong> sell your personal information. You can
        decline ad cookies via the consent banner at the bottom of the
        page; declining suppresses the AdSense script entirely. You can
        also opt out of personalized advertising directly at{"
        <a
...
<section id="children" title="7. Children's Privacy">
    <p>The Service is intended for senior high school students and
        others preparing for the UPCAT, typically aged(".")
        <strong>sixteen (16) years and older</strong>. We do not
        knowingly collect personal information from children under the
        age of 13. If you are a parent or guardian and believe that a
        child under 13 has provided us with personal information, please
        contact us so that we can promptly delete the data.
    </p>
</section>
...
<section id="changes" title="8. Changes to This Policy">
    <p>We may update this Privacy Policy from time to time to reflect
        ...
        other factors. When we do, we will update the &ldquo;Last
        updated&rdquo; date above and, when changes are material,
