...
export default function StudyPlanSetupPage() {
    ...
    const [selfAssessment, setSelfAssessment] = useStateRecord<SubjectArea, "beginner" | "intermediate" | "advanced">(
                ...
                <div className="mt-3 grid gap-2 sm:grid-cols-3">
                    [{{
                        ...
                        <button
                            ...
                            className={`
                                rounded-lg border px-3 py-2 text-sm ${diagnosticMethod === opt.value ? "border-sky-500 bg-sky-50" : "border-slate-300 hover:bg-slate-50"}
                            `}
                        >
                            {opt.label}
                        </button>
                        ...
                        {SUBJECT_AREAS.map((subject) => (
                            <label key={subject} className="text-sm">
                                ...
                                <select
                                    ...
                                    onChange={(e) => setSelfAssessment({ ...selfAssessment, [subject]: e.target.value })}
                                >
...
<div className="mt-3 grid gap-3 sm:grid-cols-3">
    ...
    <select
        ...
        onChange={(e) => setParameters((prev) => ({...prev, difficultyPreference: e.target.value as any}))}
    >
