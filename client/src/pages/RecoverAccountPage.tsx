...
<p>Can't use a recovery code or remember your security answers? Open a support ticket and our team will verify your identity manually (usually within 1-2 business days).</p>
<Link to="/support/guest" className="btn-primary inline-block">Open a support ticket</Link>
</div>
);
}

// Silence unused-import warning when a future hook is added.
export type _ ProviderRef = SocialProvider;