...
export default function BlogListPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    setError(null);
    apiClient.get<ListResponse>("/blog", {params: {page, search: search || undefined, tag: tag || undefined}})
    then((res) => {
  ...
  return (
    <div className="mx-auto max-w-5x1 px-4 py-10">
      ...
      <header className="mb-8 text-center">
        <h1 className="text-3x1 font-bold tracking-tight text-slate-900">UPCAT Reviewer Blog</h1>
