        ...
        <div className="mx-auto max-w-3xl px-4 py-12">
            ...
            <nav aria-label="Table of contents" className="mt-8 rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <ol className="mt-3 grid gap-2 sm:grid-cols-2">
                    {SECTIONS.map((s) => (
                        <li key={s.id}>
                            <a href={`#${s.id}`} className="block rounded-md px-2 py-1 text-sm text-primary-600 hover:bg-primary-50 hover:text-primary-700 transition-colors">
                                {s.title}
                            </a>
                        </li>
                    ))}
            ...
            <article className="legal-prose mt-10 space-y-12 text-gray-800">
                <Section id="acceptance" title="1. Acceptance of Terms">
                    <p>
                        By accessing or using the UPCAT Simulator service (the &ldquo;Service&rdquo;), you (&ldquo;User&rdquo;) acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions (&ldquo;Terms&rdquo;). If you do not agree to any portion of these Terms, you must discontinue use of the Service immediately.
                    </p>
                    <p>
                        These Terms constitute a legally binding agreement between you and the operator of the Service. Your continued use of the Service following any modification to these Terms shall constitute acceptance of such modifications.
                    </p>
                </Section>
                <Section id="service" title="2. Description of Service">
                    <p>
                        UPCAT Simulator is an{" "}
                        <strong>independent online practice platform</strong> designed to help users prepare for the University of the Philippines College Admission Test (UPCAT). The Service provides simulated practice examinations, performance analytics, and review materials for educational purposes only.
                    </p>
                    <p>
                        The Service is hosted on <strong>cloud computing infrastructure</strong> and uses a <strong>managed cloud database service</strong> for data storage. These platforms provide the underlying infrastructure for availability, security, and performance. See our{" "}
                        <Link to="/privacy" className="font-medium text-primary-600 underline-offset-2 hover:underline">
                            Privacy Policy
                        </Link>
                    </p>
                </Section>
...
(collectively, the &ldquo;Content&rdquo;), is the exclusive
property of the Operator or its licensors and is protected by
applicable Philippine and international intellectual property
laws.
</p>
</p>
...
<Section id="disclaimers" title="6. Disclaimers">
    ...
    <p>
        ...
        <strong>not affiliated with,</strong> endorsed by, sponsored by, or
