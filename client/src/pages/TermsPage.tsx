            ...
            <article className="legal-prose mt-10 space-y-12 text-gray-800">
                <Section id="acceptance" title="1. Acceptance of Terms">
                    <p>
                        ...
                        Conditions ("Terms"). If you do not agree to any portion of
                        these Terms, you must discontinue use of the Service
                        immediately.
                    </p>
                    <p>
                        These Terms constitute a legally binding agreement between
                        you and the operator of the Service. Your continued use of
                        the Service following any modification to these Terms shall
                ...
                <Section id="service" title="2. Description of Service">
                    <p>
                        UPCAT Simulator is an <strong>independent online practice platform</strong>
                        designed to help users prepare for the University of the
                        Philippines College Admission Test (UPCAT). The Service
                        provides simulated practice examinations, performance
                        analytics, and review materials for educational purposes
                        only.
                    </p>
                    <p>
                        The Service is hosted on <strong>cloud computing infrastructure</strong>
                        and uses a <strong>managed cloud database service</strong>
                        for data storage. These platforms provide the underlying
                        infrastructure for availability, security, and performance.
                        See our <Link
                            to="/privacy"
                            className="font-medium text-primary-600 underline-offset-2 hover:underline"
                        >
                            Privacy Policy
                        </Link> for more details on how your data is handled.
                    </p>
                    <p>
                        ...
                        content. All questions, passages, and materials provided
                        through the Service are original works or items inspired by
                        public-domain educational resources.
                    </p>
                    <p>
                        <strong>No Guarantee of Performance.</strong> The Operator
                        makes no representations, warranties, or guarantees,
                        express or implied, regarding any User's performance on the
                        actual UPCAT examination or admission to any academic
                        institution. Use of the Service does not guarantee any
                        particular score, outcome, or result.
                    </p>
                </Section>
                ...
                <Section id="accounts" title="3. User Accounts">
                    ...
                    <ul>
                        ...
                        <li>You will register and maintain only <strong>one (1) account per individual</strong>.</li>
                    </ul>
                    <p>
                        You are solely responsible for safeguarding the credentials
                        used to access your account and for any activity occurring
                        under your account, whether or not authorized. You agree to
                        notify the Operator immediately of any unauthorized use of
                ...
                <Section id="use" title="4. Acceptable Use">
                    ...
                    <ul>
                        <li>Sharing your account credentials with any other person or permitting another person to access the Service through your account;</li>
                        <li>Scraping, harvesting, or otherwise extracting questions, passages, rationales, or other content from the Service through automated means or otherwise;</li>
                        <li>Using the Service or any content obtained therefrom for any commercial purpose, including but not limited to reselling, redistributing, or incorporating such content into competing products;</li>
                        <li>Reverse-engineering, decompiling, or attempting to derive the source code of the Service;</li>
                        <li>Interfering with, disrupting, or attempting to gain unauthorized access to the Service, its servers, or related systems;</li>
                ...
                <Section id="ip" title="5. Intellectual Property">
                    <p>
                        All content made available through the Service, including but
                        not limited to text, graphics, logos, icons, images, audio
                        clips, video clips, data compilations, software, questions,
                        answer choices, rationales, and arrangements thereof
                        (collectively, the "Content"), is the exclusive property of
                        the Operator or its licensors and is protected by applicable
                        Philippine and international intellectual property laws.
                    </p>
                    <p>
                        ...
                        purposes. No other rights are granted expressly or by
                        implication.
                    </p>
                </Section>
                ...
                <Section id="disclaimers" title="6. Disclaimers">
                    ...
                    <p>
                        <strong>No Affiliation.</strong> The Service is not
                        affiliated with, endorsed by, sponsored by, or otherwise
                        connected to the University of the Philippines, the UPCAT
                        examination, or any of their administrators, employees, or
                        contractors. Any references to "UPCAT" or related
                        terminology are for descriptive and educational purposes
                        only.
                    </p>
                    <p>
                        <strong>Original or Public-Domain Material.</strong> All
                        questions and content provided through the Service are
                        original works created for educational purposes or derived
                ...
                <Section id="liability" title="7. Limitation of Liability">
                    <p>
                        ...
                        event shall the Operator, its affiliates, officers,
                        employees, agents, or licensees be liable for any indirect,
                    ...
                    <p>
                        ...
                        months preceding the event giving rise to the claim. If you
                        have paid nothing for the Service, the Operator's aggregate
                ...
                <Section id="termination" title="8. Termination">
                    <p>
                        ...
                        but not limited to (i) breach of these Terms, (ii) conduct
                        that the Operator deems harmful to the Service or other users,
                        or (iii) prolonged inactivity.
                    </p>
                    <p>
                        Upon termination, your right to use the Service will cease
                        immediately. Sections 5 (Intellectual Property), 6
                        (Disclaimers), 7 (Limitation of Liability), and 10
                ...
                <Section id="changes" title="9. Changes to Terms">
                    <p>
                        ...
                        revised Terms at this URL and updating the "Last updated"
                        date above. Material changes will be communicated through the
                        Service or via the email address associated with your account
                ...
                <Section id="contact" title="11. Contact Information">
                    <p>
                        ...
                        these Terms or the Service, please contact us through the
...
function Section({
    ...
    return (
        <section id={id} aria-labelledby={`${id}-h`} className="scroll-mt-24">
            <h2 id={`${id}-h`} className="text-xl font-bold tracking-tight text-gray-900">
                {title}
            </h2>
