        ...
        <div className="mx-auto max-w-3xl px-4 py-12">
            ...
            <article className="legal-prose mt-10 space-y-12 text-gray-800">
                <Section id="acceptance" title="1. Acceptance of Terms">
                    <p>By accessing or using the UPCAT Simulator service (the &ldquo;Service&rdquo;), you (&ldquo;User&rdquo;) acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions (&ldquo;Terms&rdquo;). If you do not agree to any portion of these Terms, you must discontinue use of the Service immediately.</p>
                    <p>These Terms constitute a legally binding agreement between you and the operator of the Service. Your continued use of the Service following any modification to these Terms shall constitute acceptance of such modifications.</p>
                </Section>

                <Section id="service" title="2. Description of Service">
                    <p>UPCAT Simulator is an independent online practice platform designed to help users prepare for the University of the Philippines College Admission Test (UPCAT). The Service provides simulated practice examinations, performance analytics, and review materials for educational purposes only.</p>
                    <p>The Service is hosted on cloud computing infrastructure and uses a managed cloud database service for data storage. These platforms provide the underlying infrastructure for availability, security, and performance. See our{" "}
                        <Link to="/privacy" className="font-medium text-primary-600 underline-offset-2 hover:underline">Privacy Policy</Link>
                    </p>
                </Section>
...
<p>
    <strong>No Guarantee of Performance.</strong> The Operator makes no representations, warranties, or guarantees, express or implied, regarding any User's performance on the actual UPCAT examination or admission to any academic institution. Use of the Service does not guarantee any particular score, outcome, or result.
</p>
</Section>

<Section id="accounts" title="3. User Accounts">
<p>To access certain features of the Service, you must register for an account. By creating an account, you represent and warrant that:</p>
<ul>
...
<p>You are solely responsible for safeguarding the credentials used to access your account and for any activity occurring under your account, whether or not authorized. You agree to notify the Operator immediately of any unauthorized use of your account or any other breach of security.</p>
</Section>
...
<p>Violation of any provision of this Section may result in immediate suspension or termination of your account.</p>
</Section>

<Section id="ip" title="5. Intellectual Property">
<p>All content made available through the Service, including but not limited to text, graphics, logos, icons, images, audio clips, video clips, data compilations, software, questions, answer choices, rationales, and arrangements thereof (collectively, the "Content"), is the exclusive property of the Operator or its licensors and is protected by applicable Philippine and international intellectual property laws.</p>
<p>
...
otherwise.connected.to<the.University.of.the
Philippines,the.UPCAT.examination,or.any.of.their
...
function Section({
  ...
  return (
    <section id={id} aria-labelledby={`${id}-h`} className="scroll-mt-24">
      <h2 id={`${id}-h`} className="text-xl font-bold tracking-tight text-gray-900">{title}</h2>
