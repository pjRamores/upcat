 ...
 * 2. Submit answer → reveal correct answer + rationale + rating buttons
...
<h1 className="text-2x1·font-semibold·text-slate-900">Session·unavailable</h1>
<p className="mt-2·text-sm·text-slate-600">{error}</p>
<Link
to="/practice"
className="mt-6·inline-block·rounded-md·bg-maroon-600·px-5·py-2·text-sm·font-semibold·text-white·shadow-sm·hover:bg-maroon-700"
>
Back to Practice
</Link>
</div>
...
<div className="rounded-2x1·border·border-slate-200·bg-white·p-8·text-center·shadow-sm">
<p className="text-sm·font-medium·text-maroon-600">Practice·complete</p>
<h1 className="mt-1·text-3x1·font-bold·text-slate-900">Nice·work!</h1>
...
className="rounded-md·bg-primary-600·px-5·py-2·text-sm·font-semibold·text-white·shadow-sm·hover:bg-primary-700"
>
Practice·again
</button>
<Link
