...
if (error) {
  return (
    <div className="mx-auto·max-w-xl·px-4·py-16·text-center">
      <h1 className="text-2x1·font-semibold·text-slate-900">Exam unavailable</h1>
...
<p className={`text-2x1 font-bold ${remainingSeconds <= 30 ? "text-rose-600" : "text-slate-900"}`}>
...
<div className={`relative·rounded-2x1·border·border-slate-200·bg-white·p-6·shadow-sm`}>
{isPaused && (
<div>
className="absolute·inset-0·z-10·flex·items-center·justify-center·rounded-2x1·backdrop-blur-sm·bg-white/60">
...
<aside className="h-fit·rounded-2x1·border·border-slate-200·bg-white·p-4·shadow-sm">
