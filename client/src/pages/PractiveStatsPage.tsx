...
<section className="mb-12">
  ...
  <div className="mb-3 flex flex-wrap items-center gap-2">
    ...
    <input
      ...
      className="flex-1 min-w-[200px] rounded-md border-slate-300 text-sm shadow-sm focus:border-primary-500 focus:ring-primary-500"
    />
  </div>
      ...
      <table className="min-w-full divide-y divide-slate-200 text-sm">
        ...
        <tbody className="divide-y divide-slate-100">
          {cards.map((c) => (
            <tr key={c.cardId}>
              <td className="px-4 py-2 text-slate-700">
                {c.questionPreview || <span className="italic text-slate-400">(no preview)</span>}
              </td>
              ...
              <td className="px-4 py-2 text-slate-600">{c.intervalDays}</td>
