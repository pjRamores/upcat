...
return (
  <div className="mx-auto max-w-5x1 px-4 py-10" data-tour="dashboard-main">
    <Seo title="Dashboard"
...
<div className="text-[10px]·font-semibold·text-amber-700">
  x{profile.streak.multiplier.toFixed(2)}·XP
</div>
</div>
</Link>
)
...
<div className="mt-5·grid·gap-4·md:grid-cols-2">
  <button
    ...
    onClick={handleStart}
    data-tour="mock-card"
    className={`w-full rounded-xl border border-maroon-200 bg-white/80 p-4 text-left shadow-sm transition
hover:bg-white cursor-pointer
focus:outline-none focus-visible:ring-2 focus-visible:ring-maroon-400`
  }
...
sessions.
    ...
    <div className="mt-4">
      <p className="text-xs·text-slate-500">
        {practiceDue
          ? `${practiceDue.dueToday} due today • ${practiceDue.deckSize} cards in your practice deck`
          : "Deck·stats·loading..."}
      </p>
    </div>
  </Link>
...
{studyToday && (
  <Link
    ...
    className="mt-6·block·rounded-xl·border·border-emerald-200·bg-gradient-to-br·from-emerald-50·to-teal-50·p-5·shadow-sm·transition·hover:from-emerald-100` +
    "hover:to-teal-100"
  >
    <div className="flex·flex-wrap·items-center·gap-4">
      <div
...
<div
  className="font-bold·text-slate-900">Day·{studyToday.dayNumber}:·{studyToday.title}</div>
