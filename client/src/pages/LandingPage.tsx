...
const LANDING_FAQ: FaqItem[] = [
    { question: "What is the UPCAT?", answer: "The UPCAT (University of the Philippines College Admission Test) is the entrance examination administered by the University of the Philippines to applicants seeking admission to its undergraduate programs. It assesses aptitude in Language Proficiency, Mathematics, Science, and Reading Comprehension." },
    { question: "How many questions are on the UPCAT?", answer: "The UPCAT consists of roughly 200 multiple-choice questions distributed across four subtests. Each subtest is timed independently and contributes to the composite University Predicted Grade (UPG) used in admissions." },
    { question: "What subjects does the UPCAT cover?", answer: "The exam covers four subject areas: Language Proficiency (English and Filipino grammar and usage), Mathematics (arithmetic through trigonometry), Science (biology, chemistry, physics, and earth science), and Reading Comprehension (long-form passages with inference and main-idea questions)." },
    { question: "How can I prepare for the UPCAT?", answer: "The most effective preparation combines spaced practice with realistic, timed simulations. Use UPCAT Simulator to take full-length mock exams under exam conditions, then drill weak subtopics with the practice mode and review explanations for every question you missed." },
    { question: "How do I get started with UPCAT Simulator?", answer: "Create an account in under a minute to access practice questions, mock exams, analytics, and review tools. You can begin with a quick setup and start practicing right away." },
    { question: "How is the score calculated?", answer: "Each mock exam reports raw correct/incorrect counts per subject area and an overall percentage. Your dashboard tracks accuracy trends, time-per-question, and subtopic mastery so you can target your weakest areas." },
    { question: "Is this affiliated with the University of the Philippines?", answer: "No. UPCAT Simulator is an independent study tool. It is not affiliated with, endorsed by, or connected to the University of the Philippines or the official UPCAT examination." }
];
...
function Hero() {
    ...
    return (
        ...
        >
            <div aria-hidden className="absolute -top-24 -left-24 h-72 w-72 rounded-full bg-primary-200/40 blur-3xl" />
            <div aria-hidden className="absolute top-40 right-24 h-80 w-80 rounded-full bg-amber-100/60 blur-3xl" />
            <div aria-hidden className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#e0e7ff_1px,transparent_1px),linear-gradient(to_bottom,#e0e7ff_1px,transparent_1px)] bg-[size:48px_48px] opacity-30 [mask-image:radial-gradient(ellipse_at_center,black_30%,transparent_70%]" />
            <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-20 sm:py-28 lg:grid-cols-12">
                <div className="lg:col-span-7" data-reveal>
                    ...
                    <p className="mt-5 max-w-xl text-lg leading-relaxed text-gray-600">
                        Thousands of questions across all subject areas. Track your progress. Know your strengths and weaknesses.
                    </p>
    ...
    return (
        <div className="relative mx-auto aspect-square w-full max-w-md">
            ...
            >
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-3 rounded-2xl bg-white p-4 shadow-xl ring-1 ring-black/5">
...
function Subjects() {
    return (
        <section className="bg-white py-20 sm:py-24">
            <div className="mx-auto max-w-6xl px-4">
                <div className="mx-auto max-w-2xl text-center" data-reveal>
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">All four UPCAT subjects covered.</h2>
                    <p className="mt-3 text-lg text-gray-600">Every subject area on the UPCAT has its own carefully curated question bank.</p>
                </div>
                ...
                <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {SUBJECT_areas.map((subject, i) => {
                        ...
                        return (
                            <div key={subject} data-reveal style={{ transitionDelay: `${i * 60}ms` }} className="group flex flex-col rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1.5 hover:shadow-lg">
                                <div className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br text-3xl ring-1 ${palette}`}>
                                    {meta.icon}
                                </div>
                                <h3 className="mt-4 text-base font-semibold text-gray-900">{meta.label}</h3>
                                <p className="mt-2 flex-1 text-sm leading-relaxed text-gray-600">{SUBJECT_DESCRIPTIONS[subject]}</p>
                            </div>
                        );
                    })}
                </div>
...
function SocialProof() {
    return (
        <section className="bg-gradient-to-r from-primary-600.to-primary-700 py-16">
            <div>
                <p className="text-sm font-semibold uppercase tracking-widest text-primary-200">Join the community</p>
                <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Join 10,000+ students preparing for the UPCAT</h2>
                <p className="mx-auto mt-4 max-w-2xl text-base text-primary-100">From Aparri to Zamboanga — students across the Philippines are using UPCAT Simulator to sharpen their skills and walk into exam day with confidence.</p>
            </div>
        </section>
    );
}
...
function ProofStat({value, label}: { value: string; label: string }) {
    return (
        <div className="rounded-2xl bg-white/10 px-4 py-5 ring-1 ring-white/20 backdrop-blur">
            ...
            <div className="mt-1 text-xs uppercase tracking-wider text-primary-100">{label}</div>
        </div>
    );
}
        ...
        <section id="faq" className="scroll-mt-24 bg-white py-20 sm:py-24">
            <div className="mx-auto max-w-3xl px-4">
                <div className="text-center data-reveal">
                    ...
                    <p className="mt-3 text-lg text-gray-600">Everything you need to know about the UPCAT and how to prepare with UPCAT Simulator.</p>
                </div>
            </div>
        </section>
    );
...
function FinalCta() {
    return (
        <section className="bg-white py-20 sm:py-24">
            <div className="mx-auto max-w-3xl rounded-3xl border border-primary-100 bg-gradient-to-br from-primary-50.to-white p-10 text-center shadow-sm sm:p-14 data-reveal">
