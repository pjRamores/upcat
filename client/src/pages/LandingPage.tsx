...
function HowItWorks() {
    ...
    >{step.number}</span>
                ...
                {SUBJECT_areas.map((subject, i) => {
                    ...
                    return (
                    <div key={subject} data-reveal style={{transitionDelay: `${i * 60}ms`}}
    ...
    return (
        <section className="bg-gradient-to-r from-primary-600.to-primary-700 py-16">
            <div>
                ...
                <p className="mx-auto mt-4 max-w-2xl text-base text-primary-100">From Aparri to Zamboanga — students
                    across the Philippines are using UPCAT Simulator to sharpen their skills and walk into exam day with
                    confidence.</p>
            </div>
        </section>
    );
