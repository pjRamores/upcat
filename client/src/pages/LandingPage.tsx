...
const LANDING_FAQ: FaqItem[] = [
  {
    ...
    answer:
      "The UPCAT (University of the Philippines College Admission Test) is the entrance examination administered by the University of the Philippines to " +
      "applicants seeking admission to its undergraduate programs. It assesses aptitude in Language Proficiency, Mathematics, Science, and Reading Comprehension.",
    },
  },
  {
    question: "How many questions are on the UPCAT?",
    answer:
      "The UPCAT consists of roughly 200 multiple-choice questions distributed across four subtests. Each subtest is timed independently and contributes to the " +
      "composite University Predicted Grade (UPG) used in admissions.",
    },
  },
  {
    question: "What subjects does the UPCAT cover?",
    answer:
      "The exam covers four subject areas: Language Proficiency (English and Filipino grammar and usage), Mathematics (arithmetic through trigonometry), " +
      "Science (biology, chemistry, physics, and earth science), and Reading Comprehension (long-form passages with inference and main-idea questions).",
    },
  },
  {
    question: "How can I prepare for the UPCAT?",
    answer:
      "The most effective preparation combines spaced practice with realistic, timed simulations. Use UPCAT Simulator to take full-length mock exams under " +
      "exam conditions, then drill weak subtopics with the practice mode and review explanations for every question you missed.",
    },
  },
  {
    question: "How is the score calculated?",
    answer:
      "Each mock exam reports raw correct/incorrect counts per subject area and an overall percentage. Your dashboard tracks accuracy trends, time-per-question, " +
      "and subtopic mastery so you can target your weakest areas.",
    },
  },
  {
    question: "Is this affiliated with the University of the Philippines?",
    answer:
      "No. UPCAT Simulator is an independent study tool. It is not affiliated with, endorsed by, or connected to the University of the Philippines or the official " +
      "UPCAT examination.",
    },
  }
];
...
function Hero() {
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="absolute -top-24 -left-24 h-72 w-72 rounded-full bg-primary-200/40 blur-3x1"
      />
      <div
        aria-hidden
        className="absolute top-40 -right-24 h-80 w-80 rounded-full bg-amber-100/60 blur-3x1"
      />
      <div
        aria-hidden
        className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#e0e7ff_1px,transparent_1px),linear-gradient(to_bottom,#e0e7ff_1px,transparent_1px)]"
      />
      "<bg-[size:48px_48px] opacity-30 [mask-image:radial-gradient(ellipse_at_center,black_30%,transparent_70%)]"
    />
    <div className="mx-auto grid max-w-6x1 items-center gap-12 px-4 py-20 sm:py-28 lg:grid-cols-12">
      <div className="lg:col-span-7" data-reveal>
        ...
        <h1 className="mt-5 text-4x1 font-extrabold leading-tight tracking-tight text-gray-900 sm:text-5x1 lg:text-6x1">
          Ace the{"}"
        </span>
        <span
...
function Stat({label, value}: {label: `string`; value: `string`}) {
  return (
    <div>
      ...
      <dd className="mt-1·text-2x1·font-bold·text-gray-900">{value}</dd>
    </div>
  );
}
...
function StudentIllustration() {
  return (
    <div className="relative·mx-auto·aspect-square·w-full·max-w-md">
      <div>
        className="absolute·inset-0·rounded-3x1·bg-gradient-to-br·from-primary-500·to-primary-700·shadow-2x1·shadow-primary-200"/>
      </div>
      <div className="absolute·left-6·right-6·top-6·rounded-2x1·bg-white·p-5·shadow-xl·ring-1·ring-black/5">
      ...
      <div>
        className="absolute·bottom-4·left-4·flex·items-center·gap-3·rounded-2x1·bg-white·p-4·shadow-xl·ring-1·ring-black/5">
  ...
  return (
    <section id="features">
      <div className="mx-auto max-w-6xl px-4">
        <div className="mx-auto max-w-2xl text-center">data-reveal</div>
...
<div className="mx-auto·max-w-2x1·text-center·data-reveal">
<h2 className="text-3xl·font-bold·tracking-tight·text-gray-900·sm:text-4x1">
...
function SocialProof() {
  return (
    <section className="bg-gradient-to-r from-primary-600 to-primary-700 py-16">
      <div
        className="mx-auto max-w-4x1 px-4 text-center text-white"
        data-reveal
      >
        <p className="text-sm font-semibold uppercase tracking-widest text-primary-200">
          Join the community
        </p>
        <h2 className="mt-3 text-3x1 font-bold sm:text-4x1">
          Join 10,000+ students preparing for the UPCAT
        </h2>
        <p className="mx-auto mt-4 max-w-2x1 text-base text-primary-100">
