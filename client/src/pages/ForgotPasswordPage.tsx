...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-120px)] items-center justify-center px-4 py-12">
      <Seo title="Forgot Password" description="Request a password reset link for your UPCAT Simulator account." noindex />
      <div className="auth-card w-full max-w-md animate-fade-in">
        {submitted ? (
          <div className="text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-green-500">
              <svg className="h-8 w-8 text-green-600" fill="none" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.817.89 5.26a2.2 2.2 0 02.002.22 0L21.8M5.19h14a2.2 2.2 0 02-2V7a2.2 2.2 0 00-2H5a2.2 2.2 0 00-2v10a2.2 2.2 0 02.2z" />
              </svg>
            </div>
            <h1 className="mt-5 text-2xl font-bold text-gray-900">Check your email</h1>
            <p className="mt-2 text-sm text-gray-600">
              If an account with <span className="font-semibold">{email}</span> exists, we've sent a password reset link.
            </p>
          ...
          <>
            ...
            <p className="mt-6 text-center text-sm text-gray-500">Remember your password?{"."}</p>
