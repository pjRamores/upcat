    ...
    <>
      ...
      <div className="mx-auto flex max-w-xl flex-col items-center px-4 py-24 text-center">
        ...
        <ul className="mt-6 grid w-full grid-cols-2 gap-2 text-sm">
          <li>
            <Link to="/" className="block rounded-md border border-gray-200 px-3 py-2 hover:border-primary-300">
              Home
            </Link>
          </li>
          <li>
            <Link to="/practice" className="block rounded-md border border-gray-200 px-3 py-2 hover:border-primary-300">
              Practice Tests
            </Link>
          </li>
          <li>
            <Link to="/leaderboard" className="block rounded-md border border-gray-200 px-3 py-2 hover:border-primary-300">
              Leaderboard
            </Link>
          </li>
          <li>
            <Link to="/contact" className="block rounded-md border border-gray-200 px-3 py-2 hover:border-primary-300">
              Contact Support
            </Link>
          </li>
        </ul>
