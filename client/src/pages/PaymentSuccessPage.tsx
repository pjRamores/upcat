    ...
    return (
        <div className="mx-auto max-w-2xl px-4 py-16 text-center">
            ...
            <div className="mt-8 flex items-center justify-center gap-3">
                <Link to="/dashboard" className="rounded-md bg-primary-600 px-4 py-2 text-sm font-semibold text-white hover:bg-primary-700">Go to Dashboard</Link>
                <Link to="/settings" className="rounded-md border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">Subscription Details</Link>
            </div>
        </div>
    );
}