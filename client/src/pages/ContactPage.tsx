...
export default function ContactPage() {
  return (
    <div className="mx-auto max-w-6x1 px-4 py-12 sm:py-16">
      <Seo
        ...
        bare
      />
      <header className="mx-auto max-w-3x1 text-center">
        ...
        <p className="mt-3 text-base text-gray-600">
          Questions, bug reports, feature ideas, or content corrections -- we
          read every message.
        </p>
      </header>

      <div className="mt-12 grid gap-10 lg:grid-cols-12">
        <div className="lg:colspan-5">
          <DeveloperCard/>
        </div>
        <div className="lg:colspan-7">
          <ContactForm/>
        </div>
      </div>
    );
  ...
  return (
    <div className="rounded-2x1 border border-gray-200 bg-white p-8 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div
          aria-hidden
          className="flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-primary-700 text-2x1 font-bold "+
          "text-white shadow-lg shadow-primary-200 ring-4 ring-white"
        >
          <div>
            </div>
            <div>
        ...
        <p className="mt-6 text-sm leading-relaxed text-gray-600">
          We built UPCAT Simulator after seeing too many students struggle with
          outdated, confusing review materials. Our mission is simple: provide
          every UPCAT-bound student with a focused, modern platform to practice
          effectively and prepare with confidence.
        </p>

        <p className="mt-3 text-sm leading-relaxed text-gray-600">
          Found a bug? Have a feature suggestion? Want to report a question
          issue? We read every message and welcome your feedback. Use the contact
          form to reach us, and we'll get back to you promptly.
        </p>
      </div>
    );
}
...
if (submitted) {
  return (
    <div className="rounded-2x1 border border-green-200 bg-green-50 p-10 text-center">
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-green-100 text-3xl">
        </div>
        <h2 className="mt-4 text-2x1 font-bold text-gray-900">Message sent!</h2>
