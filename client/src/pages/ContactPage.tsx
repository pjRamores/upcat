  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <p className="mt-3 text-sm leading-relaxed text-gray-600">
        Found a bug? Have a feature suggestion? Want to report a question issue?
        We read every message and welcome your feedback. Use the contact form to
        reach us, and we'll get back to you promptly.
      </p>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-xs text-gray-400">
        ...
        provided regarding your message. We don't share your contact info with
        third parties.
      </p>
    </form>
  );
