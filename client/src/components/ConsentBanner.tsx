  ...
  useEffect(() => {
    ...
    return (
      <div
        ...
        className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white shadow-2x1"
      >
        <div
          className="mx-auto flex max-w-6x1 flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
