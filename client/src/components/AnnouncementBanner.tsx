  ...
  return (
    <div className="space-y-2 px-4 pt-3 lg:px-8">
      {visible.map((a) => {
        ...
        return (
          <div key={a._id} role="status" className={`flex items-start gap-3 rounded-lg border ${s.border} ${s.bg} ${s.text} px-4 py-3 text-sm shadow-sm`}>
            ...
            }} aria-label="Dismiss announcement" className="rounded-md p-1 hover:bg-white/40">
              ×
            </button>
          </div>
        );
