...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/85 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/70">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <Link to={isAuthenticated ? (isAdmin ? "/admin" : "/dashboard") : "/"} className="group flex items-center gap-2 text-lg font-bold text-primary-600 hover:text-primary-700 transition-colors">
...
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-6 w-6"><path strokeLinecap="round" strokeLinejoin="round" d="M4.616 12h16M4.616 18h16M4.616 18"/></svg>
</button>
</div>
</div>
