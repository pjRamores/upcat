    ...
    success: {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} className="h-5 w-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13.4L19.7 7"/>
            </svg>
        ),
    },
    error: {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} className="h-5 w-5">
                <path strokeLinecap="round" strokeLinejoin="round"
                      d="M12.9v4m0.4h.01M10.29 3.86 1.82 18a2.2 2.2 0 0 0 1.71 3h16.94a2.2 2.2 0 0 0 1.71-3L13.71 3.86a2.2 2.2 0 0 0-3.42 0z"/>
            </svg>
        ),
    },
    warning: {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} className="h-5 w-5">
                <path strokeLinecap="round" strokeLinejoin="round"
                      d="M12.8v4m0.4h.01M4.93 19h14.14a2.2 2.2 0 0 0 1.73-3L13.73 4a2.2 2.2 0 0 0-3.46 0L3.2 16a2.2 2.2 0 0 0 1.73 3z"/>
            </svg>
        ),
    },
    info: {
        ...
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} className="h-5 w-5">
                <path strokeLinecap="round" strokeLinejoin="round"
                      d="M13.16h-1v-4h-1m-4h.01M12-22a10 10 0 1 0 10 0 10 10 0 0 0-10 0z"/>
            </svg>
        ),
    },
};
        ...
        <div className="flex items-start gap-3 p-4">
            ...
            >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-4 w-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6.18 18.6M6.18 12.6M6.18 6.6M6.18 0.6M18.6 6.18M24 6.18M12.6 6.18M6.6 6.18M0.6 6.18M6.18 18.6M6.18 12.6M6.18 6.6M6.18 0.6M18.6 6.18M24 6.18M12.6 6.18M6.6 6.18M0.6 6.18" />
                </svg>
            </button>
        </div>
        {toast.duration > 0 && (
