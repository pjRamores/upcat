...
const PALETTE: Record<ToastType, PaletteEntry> = {
  ...
  warning: {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.2} className="h-5 w-5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4m0 4h.01M4.93 19h14.14a2 2 0 0 0 1.73-3L13.73 4a2 2 0 0 0-3.46 0L3.2 16a2 2 0 0 0 1.73 3z"/>
      </svg>
    ),
  },
};
    ...
    <role={toast.type === "error" || toast.type === "warning" ? "alert" : "status"}>
      ...
      >
        ...
        <button
          ...
          className="-m-1 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-gray-400 hover:bg-gray-100 hover:text-gray-600 "+>
