...
const SITE_URL = (import.meta.env.VITE_SITE_URL as string | undefined) ?? DEFAULT_SITE_URL;
...
/**
 * Drop-in SEO component that auto-pulls title / description / keywords / indexable flag from the shared 'PAGE_SEO' registry based on the current pathname, attaches a BreadcrumbList JSON-LD when breadcrumbs are configured, and lets callers append page-specific structured data.
 */
