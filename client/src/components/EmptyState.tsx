...
const DefaultIcon = (
    ...
    >
        <path d="M8.24h12l4.8h16l4-8h12v24a4 4 0 0 1-4-4H12a4 4 0 0 1-4-4V24Z" stroke="currentColor" strokeWidth="2.5"
              strokeLinejoin="round"/>
        <path d="M16.24V14a2 2 0 0 1 2-2h28a2 2 0 0 1 2 2v10" stroke="currentColor" strokeWidth="2.5"
              strokeLinejoin="round"/>
...
export default function EmptyState({
    ...
    return (
        <div role="status"
             className={`flex flex-col items-center justify-center rounded-2xl border-dashed border-gray-200 bg-white p-10 text-center ${className}`}>
