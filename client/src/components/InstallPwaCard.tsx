            ...
            <div className="flex items-start gap-3">
                <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                        <button type="button" onClick={handleInstall} className="rounded-md bg-primary-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-primary-700">
                            Install
                        </button>
                        <button type="button" onClick={handleClose} className="rounded-md px-2 py-1.5 text-xs font-medium text-slate-500 hover:bg-slate-100">
                            Not now
                        </button>
                    </div>
                    <button type="button" onClick={handleClose} aria-label="Dismiss" className="mt-1 mr-1 rounded p-1 text-slate-400 hover:bg-slate-100 hover:text-slate-600">
                        ×
                    </button>
                </div>
            </div>
