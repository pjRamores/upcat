...
const FOCUSABLE_SELECTOR = `
    a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex]:not(-1), [contenteditable]`;
...
return createPortal(
    ...
    >
        ...
        <div ref={panelRef} tabIndex={-1} className={[
            "relative w-full overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5 animate-scale-in",
            SIZE_CLASS[size],
        ].join(" ")}>
