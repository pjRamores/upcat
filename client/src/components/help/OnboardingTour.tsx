...
{hasSpotlight && (
<div
className="pointer-events-none absolute rounded-x1 border-2 border-primary-300 shadow-[0_0_0_200vmax_rgba(0,0,0,0.55)] transition-all duration-300"
style={{
...
<section className="rounded-x1 bg-white p-4 shadow-2x1">
