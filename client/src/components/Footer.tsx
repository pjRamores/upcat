 ...
 * Bottom bar with copyright and "Made with ❤️ in the Philippines"
        ...
        >
            <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
                <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        <Link to="/">
                            <span className="text-2xl">UPCAT Simulator</span>
                        </Link>
                        <p className="mt-3 text-sm leading-relaxed text-slate-400">
                            A modern practice platform for UPCAT-bound students. Realistic exams, instant scoring, and analytics — built to help learners walk into exam day prepared.
                        </p>
                        <p className="mt-4 rounded-md border border-slate-700/60 bg-slate-800/60 p-3 text-xs leading-relaxed text-slate-400">
                            <strong className="text-slate-200">Disclaimer:</strong> Not affiliated with, endorsed by, or connected to the University of the Philippines or the UPCAT examination.
                        </p>
                    </div>
