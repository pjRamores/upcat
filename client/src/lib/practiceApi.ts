 ...
 *
 * Returns the unwrapped `data` payload from the server envelope, matching
 * the convention used by gamificationApi/accountApi.
 */
import apiClient from "@/lib/api";
import {
  API_ROUTES_V12,
  typePracticeAnswerResponse,
  typePracticeCardListEntry,
  typePracticeCardStatus,
  typePracticeCompleteResponse,
  typePracticeMode,
  typePracticeRateResponse,
  typePracticeRating,
  typePracticeStartPayload,
  typePracticeStartResponse,
...
export interface PracticeStartResult extends Omit<PracticeStartResponse, "sessionId"> {
...
export const practiceApi = {
  ...
  stats: () =>
  unwrap<PracticeStatsResponse>(apiClient.get(API_ROUTES_V12.PRACTICE.STATS)),
}
...
export const PRACTICE_MODE_DESCRIPTIONS: Record<PracticeMode, string> = {
  ...
  weak_areas: "Targets your two lowest-accuracy subjects with due cards + a few new ones.",
  ...
  random: "Anytime practice — pull random cards from your entire deck. Perfect for quick sessions.",
};
