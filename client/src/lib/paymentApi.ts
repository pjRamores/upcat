...
export const paymentApi = {
    ...
    submissionDetail: (submissionNumber: string) => {
        unwrapRecord<string, unknown>(apiClient.get(API_ROUTES.PAYMENT.MANUAL_SUBMISSION(submissionNumber)),
    },
...
pangMeryendaStatus: (transactionId: string) =>
  unwrap<{ transactionId: string; status: string; amount: number | null; completedAt: string | null }>(
