...
export const helpApi = {
     ...
     */
    listArticles: async (params: { category?: string; search?: string; page?: number; limit?: number }): Promise<{ items: { slug: string; title: string; subtitle: string; category: string }[] }> => {
...
contextual: (page: string) => unwrap<{ items: ContextualHelpPoint[]; isNewUser: boolean }>({
