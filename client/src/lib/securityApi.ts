...
blockIp: (ip: string, body: {severity?: string; reason?: string; duration?: number}) =>
...
blockRange: (body: {cidr?: string; severity?: string; reason?: string; duration?: number}) =>
...
return unwrap({items: Array<Record<string, unknown>>; total: number}>(
...
apiClient.post(API_ROUTES_V15.ADMIN.LOCKDOWN_ENABLE, {confirmCode: "LOCKDOWN", password}),
...
bySeverity: Array<{id: string; count: number}>;
