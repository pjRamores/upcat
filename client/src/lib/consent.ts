/**
 * Persisted consent record helpers. Storage is best-effort — when localStorage
 * is unavailable (private mode, embed contexts) we silently treat consent as
 * 'unset' and avoid throwing.
 */
import {
    CONSENT_STORAGE_KEY,
    CONSENT_VERSION,
