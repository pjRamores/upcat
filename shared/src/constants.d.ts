...
export declare const DIFFICULTIES: readonly ["easy", "medium", "hard", "very_hard"];
...
export declare const API_ROUTES_V12: {
  ...
  readonly PRACTICE: {
    ...
    readonly ANSWER: (id: string) => string;
    readonly RATE: (id: string) => string;
    readonly COMPLETE: (id: string) => string;
    readonly STATS: "/practice/stats";
    readonly CARDS: "/practice/cards";
    readonly BOOTSTRAP: "/practice/bootstrap";
  };
  readonly PUSH: {
    readonly PUBLIC_KEY: "/push/public-key";
    readonly SUBSCRIBE: "/push/subscribe";
    readonly UNSUBSCRIBE: "/push/unsubscribe";
    readonly PREFERENCES: "/push/preferences";
  };
  readonly ADMIN: {
    readonly GAMIFICATION: "/admin/gamification";
    readonly GAMIFICATION_GRANT_XP: "/admin/gamification/grant-xp";
    readonly GAMIFICATION_ACHIEVEMENT: (id: string) => string;
    readonly GAMIFICATION_ACHIEVEMENTS: "/admin/gamification/achievements";
    readonly GAMIFICATION_CHALLENGES: "/admin/gamification/challenges";
    readonly PUSH_TEST: "/admin/push/test";
    readonly PUSH_BROADCAST: "/admin/push/broadcast";
  };
};
...
export interface AchievementCatalogSeed {
  id: string;
  category: "milestone" | "performance" | "streak" | "dedication" | "mastery" | "social";
...
export declare const ACHIEVEMENT_CATALOG_SEED: AchievementCatalogSeed[];
export interface WeeklyChallengeCatalogSeed {
  id: string;
  title: string;
  description: string;
  metric: "exams_completed" | "questions_correct" | "study_minutes" | "practice_sessions" | "perfect_scores" | "score_above_threshold";
  target: number;
  threshold?: number;
  xpReward: number;
  weight?: number;
...
export declare const WEEKLY_CHALLENGE_CATALOG_SEED: WeeklyChallengeCatalogSeed[];
...
export declare const SECURITY_EVENT_TYPES: readonly ["rate_limit.exceeded", "rate_limit.ip_blocked", "auth.brute_force_detected", "auth.credential_stuffing_detected",
  "auth.impossible_travel", "auth.suspicious_login", "auth.account_takeover_attempt", "auth.failed_login", "auth.unknown_account", "bot.detected", "bot.captcha_failed",
  "bot.scraping_detected", "bot.honeypot_triggered", "bot.timing_trap", "dos.spike_detected", "dos.slowloris_detected", "input.injection_attempt", "input.xss_attempt",
  "input.payload_too_large", "input.proto_pollution", "session.hijack_attempt", "session.token_reuse", "session.revoked", "admin.unauthorized_access_attempt",
  "admin.lockdown_enabled", "admin.lockdown_disabled", "admin.manual_block_added", "admin.manual_block_removed", "admin.config_changed", "admin.sessions_revoked_all",
  "content.mass_flagging", "exam.answer_automation_detected", "cors.unauthorized_origin"];
...
export declare const REPUTATION_THRESHOLDS: {
  readonly trusted: 0;
  readonly neutral: 15;
  readonly suspicious: 50;
  readonly blocked: 85;
};

export declare function classifyThreatScore(score: number): import("./types.js").IpReputation;
...
export declare const DEFAULT_SECURITY_CONFIG: {
  ...
  readonly rateLimits: {
    ...
    readonly perIp: {
      ...
      readonly requestsPerHour: 2000;
      readonly requestsPerDay: 20000;
    };
    readonly perUser: {
...
readonly·SESSION_REVOKE_ALL:·"/account/security/sessions/revoke-all";
...
export·declare·const·PUZZLE_PIECE_SIZE = 48;
