...
export const API_ROUTES = {
    ...
    ACCOUNT_DELETION_REQUEST_CONFIRM: (id: string) => `/account/deletion-request/${id}/confirm`,
    ACCOUNT_DELETION_REQUEST_CANCEL: (id: string) => `/account/deletion-request/${id}/cancel`,
    SUPPORT: {
...
ADMIN: {
    ...
    FLAG_SUMMARY: "admin/content-flags/summary",
...
export const CRON_SCHEDULES = {
    ...
    autoCloseStaleTickets: "0_3.*.*.*", // daily at 03:00
    accountInactivityCheck: "0_4.*.*.0", // weekly Sunday at 04:00
} as const;
...
assignWeeklyChallenges: "0 4 * * *", // Mondays 04:00 UTC
...
};
{
    ...
    "POST /api/auth/social/start": {perIp: {perHour: 30}},
