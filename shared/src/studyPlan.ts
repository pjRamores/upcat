...
export interface StudyLesson {
    ...
    content: {
        ...
        body: string | null;
        sections: {
            type: "text" | "definition" | "formula" | "example" | "tip" | "warning" | "summary" | "diagram_placeholder";
            title: string | null;
            content: string;
            formula: string | null;
            example: {
...
MODULE ASSESSMENT_START: (planId: string, moduleId: string) => '/study-plan/${planId}/module/${moduleId}/assessment/start',
ASSESSMENT_QUESTIONS: (assessmentSessionId: string) => '/study-plan/assessment/${assessmentSessionId}/questions',
ASSESSMENT_ANSWER: (assessmentSessionId: string) => '/study-plan/assessment/${assessmentSessionId}/answer',
ASSESSMENT_SUBMIT: (assessmentSessionId: string) => '/study-plan/assessment/${assessmentSessionId}/submit',
ASSESSMENT_REVIEW: (assessmentSessionId: string) => '/study-plan/assessment/${assessmentSessionId}/review',
