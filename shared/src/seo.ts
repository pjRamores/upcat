...
export const PAGE_SEO: Record<string, PageSeoConfig> = {
    "/": {
        path: "/",
        title:
            "UPCAT Simulator - Free Practice Exams for UP College Admission Test",
        bareTitle: true,
        description:
            "Prepare for the UPCAT with thousands of realistic practice questions. Track your progress, identify weak areas, and boost your confidence. Free to start.",
        keywords: [
            "UPCAT reviewer",
            "UPCAT practice test",
            "UPCAT simulator",
    ...
    "/login": {
        ...
        bareTitle: true,
        description:
            "Log in to your UPCAT Simulator account to continue practicing for the UP College Admission Test.",
        indexable: true,
        priority: 0.5,
        changefreq: "monthly",
    ...
    "/register": {
        ...
        bareTitle: true,
        description:
            "Sign up for free and get instant access to UPCAT practice exams, mock tests, and detailed performance analytics.",
        indexable: true,
        priority: 0.8,
        changefreq: "monthly",
        breadcrumbs: [
    ...
    "/leaderboard": {
        ...
        bareTitle: true,
        description:
            "See who's leading the pack. Compare your scores with thousands of UPCAT reviewees and climb the rankings.",
        indexable: true,
        priority: 0.6,
        changefreq: "daily",
        breadcrumbs: [
    ...
    "/terms": {
        ...
        bareTitle: true,
        description:
            "Read the terms and conditions for using UPCAT Simulator, our free UPCAT practice platform.",
        indexable: true,
        priority: 0.4,
        changefreq: "monthly",
        breadcrumbs: [
    ...
    "/privacy": {
        ...
        bareTitle: true,
        description:
            "Learn how UPCAT Simulator protects your data and your privacy while you prepare for the UPCAT.",
        indexable: true,
        priority: 0.4,
        changefreq: "monthly",
        breadcrumbs: [
    ...
    "/contact": {
        ...
        bareTitle: true,
        description:
            "Get in touch with the UPCAT Simulator team. Questions, bug reports, and partnerships welcome.",
        indexable: true,
        priority: 0.4,
        changefreq: "monthly",
        breadcrumbs: [
    ...
    "/subjects/mathematics": {
        ...
        bareTitle: true,
        description:
            "Master UPCAT Mathematics with focused practice on arithmetic, algebra, geometry, and trigonometry. Solve realistic sample questions with detailed solutions.",
        keywords: [
    ...
    "/subjects/language-proficiency": {
        ...
        bareTitle: true,
        description:
            "Improve your UPCAT Language Proficiency score with grammar, vocabulary, and usage practice in both English and Filipino.",
        keywords: [
