...
export const API_ROUTES = {
  ...
  ACCOUNT_DATA_EXPORT_ID: (id) => `/account/data-export/${id}/download`,
...
export const ACHIEVEMENT_CATALOG_SEED = [
  ...
  { id: "first_steps", category: "milestone", rarity: "common", title: "First Steps", description: "Complete your very first practice exam.", icon: "footprints",
    xpReward: 50, points: 10, condition: { kind: "examCount", gte: 1 } },
  { id: "getting_serious", category: "milestone", rarity: "common", title: "Getting Serious", description: "Complete 5 practice exams.", icon: "book-open",
    xpReward: 100, points: 20, condition: { kind: "examCount", gte: 5 } },
  { id: "dedicated_learner", category: "milestone", rarity: "uncommon", title: "Dedicated Learner", description: "Complete 25 practice exams.", icon: "graduation-cap",
    xpReward: 250, points: 50, condition: { kind: "examCount", gte: 25 } },
  { id: "exam_machine", category: "milestone", rarity: "rare", title: "Exam Machine", description: "Complete 100 practice exams.", icon: "rocket",
    xpReward: 500, points: 100, condition: { kind: "examCount", gte: 100 } },
  { id: "exam_titan", category: "milestone", rarity: "epic", title: "Exam Titan", description: "Complete 250 practice exams.", icon: "mountain",
    xpReward: 1000, points: 250, condition: { kind: "examCount", gte: 250 } },
  // -- Performance --
  { id: "high_scorer", category: "performance", rarity: "uncommon", title: "High Scorer", description: "Score 80% or higher on a practice exam.", icon: "trophy",
    xpReward: 100, points: 25, condition: { kind: "scoreThreshold", gte: 80, count: 1 } },
  { id: "top_of_class", category: "performance", rarity: "rare", title: "Top of the Class", description: "Score 90% or higher on a practice exam.", icon: "award",
    xpReward: 200, points: 50, condition: { kind: "scoreThreshold", gte: 90, count: 1 } },
  { id: "flawless", category: "performance", rarity: "legendary", title: "Flawless Victory", description: "Achieve a perfect 100% on a practice exam.", icon: "crown",
    xpReward: 500, points: 200, condition: { kind: "perfectScores", gte: 1 } },
  { id: "perfectionist", category: "performance", rarity: "epic", title: "Perfectionist", description: "Achieve 5 perfect scores.", icon: "diamond",
    xpReward: 1000, points: 300, condition: { kind: "perfectScores", gte: 5 } },
  { id: "consistent_excellence", category: "performance", rarity: "epic", title: "Consistent Excellence", description: "Score 90%+ on 10 different exams.", icon: "shield-check",
    xpReward: 750, points: 200, condition: { kind: "scoreThreshold", gte: 90, count: 10 } },
  // -- Streams --
  { id: "warming_up", category: "streak", rarity: "common", title: "Warming Up", description: "Maintain a 3-day study streak.", icon: "flame",
    xpReward: 50, points: 15, condition: { kind: "streakDays", gte: 3 } },
  { id: "on_fire", category: "streak", rarity: "uncommon", title: "On Fire", description: "Maintain a 7-day study streak.", icon: "flame",
    xpReward: 150, points: 40, condition: { kind: "streakDays", gte: 7 } },
  { id: "fortnight_focus", category: "streak", rarity: "rare", title: "Fortnight Focus", description: "Maintain a 14-day study streak.", icon: "calendar-days",
    xpReward: 300, points: 75, condition: { kind: "streakDays", gte: 14 } },
  { id: "unstoppable", category: "streak", rarity: "epic", title: "Unstoppable", description: "Maintain a 30-day study streak.", icon: "zap",
    xpReward: 750, points: 200, condition: { kind: "streakDays", gte: 30 } },
  { id: "legendary_dedication", category: "streak", rarity: "legendary", title: "Legendary Dedication", description: "Maintain a 100-day study streak.", icon: "star",
    xpReward: 2500, points: 500, condition: { kind: "streakDays", gte: 100 } },
  // -- Dedication --
  { id: "early_bird", category: "dedication", rarity: "common", title: "Early Bird", description: "Answer 100 questions in total.", icon: "sunrise",
    xpReward: 75, points: 20, condition: { kind: "questionsAnswered", gte: 100 } },
  { id: "knowledge_seeker", category: "dedication", rarity: "uncommon", title: "Knowledge Seeker", description: "Answer 500 questions in total.", icon: "search",
    xpReward: 200, points: 50, condition: { kind: "questionsAnswered", gte: 500 } },
  { id: "scholar", category: "dedication", rarity: "rare", title: "Scholar", description: "Answer 2,000 questions in total.", icon: "library",
    xpReward: 500, points: 125, condition: { kind: "questionsAnswered", gte: 2000 } },
  { id: "marathon_mind", category: "dedication", rarity: "epic", title: "Marathon Mind", description: "Accumulate 1,000 minutes of study time.", icon: "timer",
    xpReward: 600, points: 150, condition: { kind: "studyMinutes", gte: 1000 } },
  { id: "deep_focus", category: "dedication", rarity: "rare", title: "Deep Focus", description: "Accumulate 300 minutes of study time.", icon: "headphones",
    xpReward: 250, points: 75, condition: { kind: "studyMinutes", gte: 300 } },
  // -- Mastery --
  { id: "master_master", category: "mastery", rarity: "rare", title: "Math Master", description: "Score 100% on a Mathematics exam.", icon: "calculator",
    xpReward: 300, points: 100, condition: { kind: "perfectSubject", subject: "Mathematics", gte: 1 } },
  { id: "science_savant", category: "mastery", rarity: "rare", title: "Science Savant", description: "Score 100% on a Science exam.", icon: "flask-conical",
    xpReward: 300, points: 100, condition: { kind: "perfectSubject", subject: "Science", gte: 1 } },
  { id: "language_luminary", category: "mastery", rarity: "rare", title: "Language Luminary", description: "Score 100% on a Language Proficiency exam.", icon: "languages",
    xpReward: 300, points: 100, condition: { kind: "perfectSubject", subject: "Science", gte: 1 } },
  { id: "reading_rockstar", category: "mastery", rarity: "rare", title: "Reading Rockstar", description: "Score 100% on a Reading Comprehension exam.", icon: "book-marked",
    xpReward: 300, points: 100, condition: { kind: "perfectSubject", subject: "Reading Comprehension", gte: 1 } },
  { id: "quadruple_threat", category: "mastery", rarity: "legendary", title: "Quadruple Threat", description: "Reach level 50.", icon: "swords",
    xpReward: 2000, points: 500, condition: { kind: "levelReached", gte: 50 } },
...
export const DEFAULT_SECURITY_CONFIG = {
  ...
  rateLimits: {
    ...
    perIp: { requestsPerMinute: 100, requestsPerHour: 2000 },
