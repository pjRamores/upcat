...
// --- Account recovery ---
/** Codes are XXXXX-XXXX-XXXX, alphanumeric, excluding ambiguous characters. */
...
export const ACHIEVEMENT_CATALOG_SEED = [
  ...
  { id: "level_25", category: "milestone", rarity: "rare", title: "Upperclassman", description: "Reach level 25.", icon: "chevrons-up", xpReward: 200, points: 50, condition: { kind: "levelReached", gte: 25 } },
  { id: "level_50", category: "milestone", rarity: "epic", title: "Senior", description: "Reach level 50.", icon: "chevrons-up", xpReward: 500, points: 100, condition: { kind: "levelReached", gte: 50 } },
  { id: "level_100", category: "milestone", rarity: "legendary", title: "Graduate", description: "Reach level 100.", icon: "graduation-cap", xpReward: 1000, points: 200, condition: { kind: "levelReached", gte: 100 } },
  // Mastery/Performance hybrids (level + score)
  { id: "level_10_perfect", category: "mastery", rarity: "rare", title: "Perfect 10", description: "Score 100% on level 10.", icon: "trophy", xpReward: 300, points: 50, condition: { kind: "levelScore", level: 10, score: 100 } },
  { id: "level_25_perfect", category: "mastery", rarity: "rare", title: "Perfect 25", description: "Score 100% on level 25.", icon: "trophy", xpReward: 500, points: 100, condition: { kind: "levelScore", level: 25, score: 100 } },
  { id: "level_50_perfect", category: "mastery", rarity: "epic", title: "Perfect 50", description: "Score 100% on level 50.", icon: "trophy", xpReward: 1000, points: 200, condition: { kind: "levelScore", level: 50, score: 100 } },
  { id: "level_100_perfect", category: "mastery", rarity: "legendary", title: "Perfect 100", description: "Score 100% on level 100.", icon: "trophy", xpReward: 2000, points: 400, condition: { kind: "levelScore", level: 100, score: 100 } },
];
script
xpReward: 300, points: 75, condition: { kind: "levelReached", gte: 25 } },
    { id: "level 50", category: "milestone", rarity: "epic", title: "Achiever", description: "Reach level 50.", icon: "trending-up", },
    { id: "level 100", category: "milestone", rarity: "legendary", title: "UPCAT Champion", description: "Reach the max level of 100.", icon: "crown", },
    { id: "level 500", points: 1000, condition: { kind: "levelReached", gte: 100 } },
...
export const CRON_SCHEDULES_V15 = {
    threatScoreDecay: "0,1,2,3,4", // hourly
