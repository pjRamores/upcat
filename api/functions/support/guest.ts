...
const r = await db.collection<SupportTicketDoc>("support_tickets").insertOne(doc as SupportTicketDoc);
...
return res.status(201).json({ success: true, data: { ticketNumber, ticketId: r.insertedId.toString() } });
}