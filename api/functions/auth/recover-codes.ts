/**
 * POST /api/auth/recovery-codes/generate ... - auth_required, mints 10 codes
 * GET /api/auth/recovery-codes/status ... - auth_required, returns metadata
 * POST /api/auth/recovery-codes/verify ... - public, returns recovery JWT
 *
 * The `action` query param disambiguates because Vercel rewrites these to a
 * single source file (see vercel.json).
 */
