 ...
 *
 * Removes the linked identity for the current user. Refuses to leave the account in an unrecoverable state: if the user has no local password AND this is their last linked identity, the request is rejected.
 */
