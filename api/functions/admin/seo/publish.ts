 ...
 *
 * Exports all SEO overrides as a static JSON snapshot that can be
 * saved to client/public/data/seo-overrides.json and bundled with
 * the app. This eliminates per-page API calls for override lookups.
 */
