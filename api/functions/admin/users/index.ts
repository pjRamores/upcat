 ...
 *
 * The create flow lives in this file as well so we can reuse the email uniqueness/role validation.
 * The router exposes both verbs via separate Vercel rewrites.
 */
...
async function createUser(
    ...
    const role = body.role === "admin" ? "admin" : "reviewee";
