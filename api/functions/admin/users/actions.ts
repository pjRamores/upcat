 ...
 *
 * The action is selected via the '?action=' query parameter so we
 * can serve all four with one Vercel function file.
 */
...
import { RESET_TOKEN_EXPIRY_HOURS } from "../../../../shared";
