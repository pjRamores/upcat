 ...
 * { config: Partial<SecurityConfig>, password: string }
 */
...
export default withSecurity({ endpoint: "ADMIN /api/admin/security/config" })(async (req: VercelRequest, res: VercelResponse) => {
