    ...
    if (def) {
      ...
      weeklyChallenge = {
        challenge: {
          ...
          createdAt: typeof def.createdAt === "string" ? def.createdAt : new Date(def.createdAt).toISOString(),
          updatedAt: typeof def.updatedAt === "string" ? def.updatedAt : new Date(def.updatedAt).toISOString(),
        },
        ...
        progressPct:
          block.weeklyChallenge.target > 0
