 ...
 *
 * Produces a 24h summary of security activity and persists it to 'security_reports' for the admin console + audit trail. Also logs a synthetic event so admins can see the report ran.
 */
