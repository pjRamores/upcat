 ...
 * and resets the daily activity counters at UTC midnight. Reputation is recomputed from the new score so neutral-but-noisy IPs gradually return to a clean state without manual intervention.
 */
