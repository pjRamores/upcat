...
function adapt(handler: Handler) {
  return (req: Request, res: Response) => {
    ...
    return Promise.resolve(handler(req as unknown as VercelRequest, res as unknown as VercelResponse)).catch((err) => {
...
// Recovery codes: single handler dispatches via ?action=
...
app.post("/api/study-plan/:planId/adapt", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { planId: req.params.planId, action: "adapt" });
  return adapt(studyPlanPlans)(req as never, res as never);
});

app.put("/api/study-plan/:planId/reschedule", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { planId: req.params.planId, action: "reschedule" });
  return adapt(studyPlanPlans)(req as never, res as never);
});

app.post("/api/study-plan/:planId/pause", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { planId: req.params.planId, action: "pause" });
  return adapt(studyPlanPlans)(req as never, res as never);
});

app.post("/api/study-plan/:planId/resume", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { planId: req.params.planId, action: "resume" });
  return adapt(studyPlanPlans)(req as never, res as never);
});

app.post("/api/study-plan/:planId/abandon", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { planId: req.params.planId, action: "abandon" });
  return adapt(studyPlanPlans)(req as never, res as never);
});

app.get("/api/study-plan/:planId/analytics", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { planId: req.params.planId, action: "analytics" });
  return adapt(studyPlanPlans)(req as never, res as never);
});

app.get("/api/admin/study-plan/templates", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "templates" });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.post("/api/admin/study-plan/templates", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "templates" });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.put("/api/admin/study-plan/templates/:id", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "templates", id: req.params.id });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.get("/api/admin/study-plan/lessons", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "lessons" });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.post("/api/admin/study-plan/lessons", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "lessons" });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.put("/api/admin/study-plan/lessons/:id", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "lessons", id: req.params.id });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.get("/api/admin/study-plan/analytics", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "analytics" });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

app.get("/api/admin/study-plan/users", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "users" });
  return adapt(studyPlanAdmin)(req as never, res as never);
});

// Cron aliases for local/serverless schedulers.
const cronStudyPlanReminders = lazy(() => import("./functions/cron/study-plan-reminders.js"));
const cronStudyPlanAdaptationCheck = lazy(() => import("./functions/cron/study-plan-adaptation-check.js"));
const cronQuestionMediaCleanup = lazy(() => import("./functions/cron/question-media-cleanup.js"));
const cronMonitoringHealthChecks = lazy(() => import("./functions/cron/monitoring-health-checks.js"));
const cronMonitoringAlertRules = lazy(() => import("./functions/cron/monitoring-alert-rules.js"));
const cronMaintenanceAutoStart = lazy(() => import("./functions/cron/maintenance-auto-start.js"));
const cronMaintenanceAutoEnd = lazy(() => import("./functions/cron/maintenance-auto-end.js"));
const cronSyncQueueCleanup = lazy(() => import("./functions/cron/sync-queue-cleanup.js"));
app.post("/api/cron/study-plan-reminders", adapt(cronStudyPlanReminders));
app.post("/api/cron/study-plan-adaptation-check", adapt(cronStudyPlanAdaptationCheck));
app.post("/api/cron/question-media-cleanup", adapt(cronQuestionMediaCleanup));
app.post("/api/cron/monitoring-health-checks", adapt(cronMonitoringHealthChecks));
app.post("/api/cron/monitoring-alert-rules", adapt(cronMonitoringAlertRules));
app.post("/api/cron/maintenance-auto-start", adapt(cronMaintenanceAutoStart));
app.post("/api/cron/maintenance-auto-end", adapt(cronMaintenanceAutoEnd));
app.post("/api/cron/sync-queue-cleanup", adapt(cronSyncQueueCleanup));

// Payments / Subscription / Feature gating.
const paymentConfig = lazy(() => import("./functions/payment/config.js"));
const paymentManual = lazy(() => import("./functions/payment/manual.js"));
const paymentPangmeryenda = lazy(() => import("./functions/payment/pangmeryenda.js"));
const paymentPromo = lazy(() => import("./functions/payment/promo-code.js"));
const featuresIndex = lazy(() => import("./functions/features/index.js"));
const subscriptionStatus = lazy(() => import("./functions/subscription/status.js"));

app.get("/api/payment/config", adapt(paymentConfig));
app.post("/api/payment/manual/submit", adapt(paymentManual));
app.get("/api/payment/manual/submissions", adapt(paymentManual));
app.get("/api/payment/manual/submissions/:submissionNumber", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { submissionNumber: req.params.submissionNumber });
  return adapt(paymentManual)(req as never, res as never);
});

app.post("/api/payment/manual/submissions/:submissionNumber/cancel", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { submissionNumber: req.params.submissionNumber });
  return adapt(paymentManual)(req as never, res as never);
});

app.post("/api/payment/pangmeryenda/initiate", adapt(paymentPangmeryenda));
app.get("/api/payment/pangmeryenda/status/:transactionId", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { transactionId: req.params.transactionId });
  return adapt(paymentPangmeryenda)(req as never, res as never);
});

app.post("/api/payment/pangmeryenda/webhook", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "webhook" });
  return adapt(paymentPangmeryenda)(req as never, res as never);
});

app.get("/api/payment/pangmeryenda/success", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, {
    action: "success",
...
app.get("/api/payment/pangmeryenda/failed", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "failed" });
  return adapt(paymentPangmeryenda)(req as never, res as never);
});

app.get("/api/payment/pangmeryenda/cancelled", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "cancelled" });
  return adapt(paymentPangmeryenda)(req as never, res as never);
});

app.post("/api/payment/promo-code/validate", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "validate" });
  return adapt(paymentPromo)(req as never, res as never);
});

app.post("/api/payment/promo-code/redeem", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "redeem" });
  return adapt(paymentPromo)(req as never, res as never);
});

app.get("/api/features/access", adapt(featuresIndex));

app.post("/api/features/check", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "check" });
  return adapt(featuresIndex)(req as never, res as never);
});

app.post("/api/features/track-usage", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "track" });
  return adapt(featuresIndex)(req as never, res as never);
});

app.get("/api/subscription/status", adapt(subscriptionStatus));

app.post("/api/subscription/cancel", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { action: "cancel" });
  return adapt(subscriptionStatus)(req as never, res as never);
});
...
app.delete("/api/admin/gamification/achievements/:id", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { resource: "achievements", id: req.params.id });
  return adapt(adminGamification)(req as never, res as never);
});
...
// guest + captcha (same handler, dispatches on method)
app.get("/api/support/captcha", adapt(supportGuest));
app.get("/api/support/tickets/guest", adapt(supportGuest));
// single ticket + messages (inject query params the handler expects)
...
app.post("/api/support/tickets/:ticketNumber/messages", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { ticketNumber: req.params.ticketNumber, messages: "1" });
  return adapt(supportTickets)(req as never, res as never);
});
...
// list / detail / reply / status / verify-identity
...
app.post("/api/admin/support/tickets/:n/messages", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { ticketNumber: req.params.n, action: "message" });
  return adapt(adminSupportTickets)(req as never, res as never);
});
app.put("/api/admin/support/tickets/:n/status", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { ticketNumber: req.params.n, action: "status" });
  return adapt(adminSupportTickets)(req as never, res as never);
});
app.post("/api/admin/support/tickets/:n/verify-identity", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { ticketNumber: req.params.n, action: "verify" });
  return adapt(adminSupportTickets)(req as never, res as never);
});
// disputes
...
// Monitoring (public/client/admin)
...
function adminMaintenanceWith(resource: string, extra: Record<string, string> = {}) {
  return (req: Request, res: Response) => {
    ...
    if (req.params?.id) (req.query as Record<string, unknown>).id = req.params.id;
...
function adminMonitoringWith(resource: string, extra: Record<string, string> = {}) {
  return (req: Request, res: Response) => {
    Object.assign(req.query as Record<string, unknown>, { resource, ...extra });
    if (req.params?.id) (req.query as Record<string, unknown>).id = req.params.id;
    if (req.params?.checkId) (req.query as Record<string, unknown>).checkId = req.params.checkId;
...
app.get("/api/account/data-export/:requestId/download", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { requestId: req.params.requestId, download: "1" });
  return adapt(accountExport)(req as never, res as never);
});
...
app.post("/api/account/deletion-request/:id/confirm", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { requestId: req.params.id, action: "confirm" });
  return adapt(accountDeletion)(req as never, res as never);
});

app.post("/api/account/deletion-request/:id/cancel", (req, res) => {
  Object.assign(req.query as Record<string, unknown>, { requestId: req.params.id, action: "cancel" });
  return adapt(accountDeletion)(req as never, res as never);
});
...
// Edge aliases so dev (and tests) can hit the root paths directly.
...
// --- Admin -- SEO (overrides + redirects + sitemap status)
...
function adminBlogWithId(req: Request, res: Response) {
  if (req.params?.id) Object.assign(req.query as Record<string, unknown>, { id: req.params.id });
