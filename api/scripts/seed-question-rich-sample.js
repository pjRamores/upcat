...
export async function seedQuestionRichSamples(db, options = {}) {
    ...
    await passages.insertOne({
        ...
        content: "Coastal communities adapt to rising sea levels through a combination of mangrove restoration, elevated housing, and relocation planning. Each option has social and economic trade-offs.",
        contentBlocks: [
...
script
console.log("v.Seeded.rich.media.question.samples.(2.questions,1.passage)");
}