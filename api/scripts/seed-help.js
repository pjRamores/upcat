...
const HELP_ARTICLES = [
    article({
        ...
        category: "getting-started",
        order: 1,
        title: "Welcome to UPSCAT Simulator",
...
**Example:** If the base reward is 75 XP and your streak multiplier is 1.75, you earn 131 XP (rounding policy may vary).
...
},
{
    ...
    type: "popover",
    title: "Weak Areas",
    shortDescription: "Identify areas that need more practice.",
    detailedContent: null,
    helpArticleSlug: "how-practice-test-works",
    helpArticleSection: null,
    showForNewUsers: true,
        ...
        steps: [
            {
                ...
                title: "Welcome to UCAT Simulator!",
