 ...
 * node scripts/seed.js --clean --force // also clean exam sessions
 *
...
const passages = [
  {
    ...
    content:
      "Photosynthesis is the process by which green plants, algae, and certain bacteria convert." +
      "light energy — usually from the sun — into chemical energy stored in glucose. The process." +
      "occurs primarily in the chloroplasts of plant cells, which contain a green pigment called." +
      "chlorophyll. Chlorophyll absorbs light most efficiently in the blue and red wavelengths." +
      "while reflecting green light, which is why most plants appear green to the human eye.\n\n" +
      "The overall reaction can be summarized as: six molecules of carbon dioxide combine with." +
      "six molecules of water in the presence of light energy to produce one molecule of glucose." +
      "and six molecules of oxygen. Photosynthesis is essential to life on Earth because it." +
      "produces nearly all of the oxygen in the atmosphere and forms the base of nearly every." +
      "food chain.",
      createdAt: NOW,
    },
    {
...
const questions = [
  ...
  q({
    ...
    correctAnswer: "B",
    rationale:
      "Area of a triangle = (1/2) × base × height = (1/2) × 10 × 6 = 30 sq cm.",
    tags: ["area", "triangles"],
  }),
  q({
    subjectArea: "Mathematics",
  ...
  q({
    ...
    correctAnswer: "B",
    rationale:
      "sin(30°) = 1/2 is one of the standard trigonometric values from the 30-60-90 triangle.",
...
correctAnswer: "B",
rationale:
"The passage opens by defining photosynthesis and concludes with its essential role in producing." +
"oxygen and forming the base of food chains. B captures both ideas."
...
console.log(
  `\n§ Gamification catalogs: ${achievements.length} achievements (` +
  `${achInserted} new), ${chenges.length} weekly challenges (` ${chInserted} new).`,
);
}
...
},
{
  ...
  escalation: null,
  tags: ["api", "latency"],
  createdBy: new ObjectId("00000000000000000000001"),
  createdAt: now,
  updatedAt: now,
  },
];
