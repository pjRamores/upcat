...
const studyLessons = [
  lessonBase({
    ...
    sections: [
      ...
      },
      {
        ...
        example: {
          problem: "x/4 + 3 = -8",
          solution: "x/4 = -11, then x = -44",
          explanation:
            "Subtract 3 from both sides, then multiply both sides by 4.",
        },
      },
      {
        type: "summary",
        title: "Quick Wrap-up",
        content:
          "Linear equations model constant-rate relationships and are foundational for algebra and graphing.",
        formula: null,
        example: null,
      },
    ],
    keyTakeaways: [
      ...
      "Keep equations balanced by doing the same operation on both sides.",
    ],
    quickReference: [
      ...
      {
        label: "Balance Rule",
        value: "Do the same operation on both sides",
      },
    ],
    ...
    sections: [
      {
        ...
        content:
          "A quadratic equation has the general form ax^2 + bx + c = 0 where a ≠ 0.",
        formula: "ax^2 + bx + c = 0",
        example: null,
      },
      {
      ...
      },
      {
        ...
        example: {
          ...
          explanation:
            "Substitute a=2, b=3, c=-2 into the formula and simplify.",
        },
      },
    ],
    keyTakeaways: [
      ...
      "The discriminant b² - 4ac tells the nature of roots.",
    ],
    quickReference: [
    ...
    sections: [
      {
        ...
        title: "Core Idea",
        content:
          "Trigonometry connects angles and side lengths in triangles. The basic ratios are sine, cosine, and tangent.",
        formula: null,
        example: null,
      },
      {
      ...
      },
      {
        ...
        example: {
          problem:
            "Right triangle with opposite=3 and hypotenuse=5. Find sin θ.",
    ...
    sections: [
      {
        ...
        title: "Cell Theory",
        content:
          "All living things are made of cells. Cells are the basic unit of life, and new cells come from pre-existing cells.",
        formula: null,
        example: null,
      },
      {
        ...
        content:
          "Nucleus stores genetic material, mitochondria produce ATP, ribosomes synthesize proteins, and cell membrane controls transport.",
        formula: null,
        example: null,
      },
      {
        ...
        example: {
          ...
          explanation:
            "Mitochondria are the cell's energy factories via cellular respiration.",
        },
      },
      {
        type: "example",
        ...
        example: {
          problem:
            "Why does water move out of a cell into a hypertonic solution?",
          solution:
            "Osmosis drives water toward the area with higher solute concentration.",
          explanation:
            "Water movement across the membrane balances concentration differences.",
        },
      },
    ],
    keyTakeaways: [
    ...
    sections: [
      {
        ...
        title: "Bond Types",
        content:
          "Ionic bonds involve electron transfer, covalent bonds involve sharing electrons, and metallic bonds involve delocalized electron clouds.",
        formula: null,
        example: null,
      },
      {
        ...
        content:
          "Electronegativity is an atom's ability to attract bonding electrons. Greater difference generally increases ionic character.",
        formula: null,
        example: null,
      },
      {
        ...
        example: {
          ...
          solution: "Ionic bond",
          explanation:
            "Metal sodium transfers an electron to nonmetal chlorine.",
        },
      },
      {
        type: "example",
        ...
        example: {
          ...
          solution:
            "Unequal electron sharing and bent geometry create a net dipole.",
          explanation:
  ...
  lessonBase({
    ...
    sections: [
      {
        ...
        title: "Three Laws",
        content:
          "First law: inertia. Second law: F = ma. Third law: action-reaction force pairs.",
        formula: "F = ma",
        example: null,
      },
      {
        ...
        content:
          "Draw a free-body diagram, list known values, choose a sign convention, and solve systematically.",
        formula: null,
        example: null,
      },
      {
      ...
      },
      {
        ...
        example: {
          problem:
            "A swimmer pushes water backward. Why does she move forward?",
          solution:
            "Water exerts an equal and opposite force on the swimmer.",
    ...
    keyTakeaways: [
      ...
      "Mass and acceleration are related through F = ma.",
  ...
  lessonBase({
    ...
    sections: [
      {
        ...
        title: "Core Rule",
        content:
          "Singular subjects take singular verbs; plural subjects take plural verbs. Ignore interrupting phrases.",
        formula: null,
        example: null,
      },
      {
        ...
        title: "Tricky Cases",
        content:
          "Watch collective nouns, compound subjects, indefinite pronouns, and words between subject and verb.",
        formula: null,
        example: null,
      },
      {
    ...
    quickReference: [
      { label: "Each / Every", value: "Usually singular" },
      {
        ...
        value: "Singular unless paired with plural near verb",
      },
      {
        label: "As well as",
        value: "Does not make subject plural",
      },
    ],
    ...
    sections: [
      {
        ...
        title: "Context Clues",
        content:
          "Infer word meaning by reading nearby clues: definition, contrast, example, or cause-and-effect context.",
        formula: null,
        example: null,
      },
      {
        ...
        title: "Word Parts",
        content:
          "Prefixes, roots, and suffixes reveal meaning. For example, 'bio' means life, and '-logy' means study.",
        formula: null,
        example: null,
      },
      {
        ...
        example: {
          ...
          explanation:
            "The contrast with verbose (wordy) implies brevity.",
        },
      },
    ],
    keyTakeaways: [
  ...
  lessonBase({
    ...
    sections: [
      {
        ...
        content:
          "Clear writing depends on complete clauses, proper punctuation, and consistent structure.",
        formula: null,
        example: null,
      },
      {
        ...
        title: "Parallelism",
        content:
          "Items in a list or paired ideas should use the same grammatical form.",
        formula: null,
        example: null,
      },
      {
    ...
    quickReference: [
      ...
      {
        label: "Common Error",
        value: "Mixed infinitive and gerund forms",
      },
    ...
    sections: [
      {
        ...
        content:
          "Skim first for structure and tone, then scan for key details tied to specific questions.",
        formula: null,
        example: null,
      },
      {
        ...
        content:
          "After each paragraph, ask what is the author doing here? Defining, arguing, contrasting, or giving evidence?",
        formula: null,
        example: null,
      },
      {
        ...
        title: "Exam Routine",
        content:
          "Preview questions, read actively, annotate quickly, and eliminate weak answer choices.",
        formula: null,
        example: null,
      },
    ],
    ...
    sections: [
      {
        ...
        content:
          "An implication is suggested by the author; an inference is concluded by the reader from clues.",
        formula: null,
        example: null,
      },
      {
        ...
        content:
          "Strong inferences combine textual clues with logical reasoning. Avoid assumptions that go beyond the passage.",
        formula: null,
        example: null,
      },
      {
        ...
        example: {
          problem:
            "The report called the proposal 'ambitious but underfunded.' What is implied?",
          solution:
            "The idea is promising but unlikely to succeed without more resources.",
          explanation:
            "Both positive and limiting language shape a cautious interpretation.",
        },
      },
    ],
    keyTakeaways: [
    ...
    sections: [
      {
        ...
        content:
          "Most arguments contain a claim, evidence, assumptions, and a line of reasoning connecting evidence to claim.",
        formula: null,
        example: null,
      },
      {
        ...
        content:
          "Watch for ad hominem, false dilemma, hasty generalization, and post hoc reasoning.",
        formula: null,
        example: null,
      },
      {
        ...
        example: {
          problem:
            "I met two rude tourists from City X, so people from City X are rude.",
          solution: "This is a hasty generalization.",
          explanation:
            "A broad claim is made from insufficient sample size.",
        },
      },
    ],
    keyTakeaways: [
...
const studyPlanTemplates = [
  templateBase({
    ...
    description:
      "Balanced, comprehensive 8-week curriculum covering all UPCAT subjects.",
    targetDuration: 8,
    targetHoursPerDay: 2,
    structure: {
      phases: [
  ...
  templateBase({
    ...
    description:
      "High-intensity plan focused on high-impact topics and weak areas.",
    targetDuration: 4,
    targetHoursPerDay: 3,
    structure: {
      phases: [
