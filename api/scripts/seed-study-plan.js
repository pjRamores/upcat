...
const studyPlanTemplates = [
    templateBase({
        ...
        structure: {
            phases: [
                { name: "Foundation", weekStart: 1, weekEnd: 2, description: "Build core concepts across all subjects.", modules: [ module("Language Proficiency", "Grammar", "Grammar Foundations", "easy", 2), module("Mathematics", "Linear Equations", "Algebra Fundamentals", "easy", 3), module("Science", "Cell Biology", "Biology Basics", "easy", 2), module("Reading Comprehension", "Passage Strategies", "Reading Basics", "easy", 2) ] },
                { name: "Strengthening", weekStart: 3, weekEnd: 5, description: "Grow speed and accuracy using mixed practice.", modules: [ module("Language Proficiency", "Vocabulary", "Academic Vocabulary", "medium", 2), module("Mathematics", "Quadratic Equations", "Quadratic Mastery", "medium", 3), module("Science", "Chemical Bonding", "Chemistry Essentials", "medium", 2), module("Reading Comprehension", "Inference", "Inference Skills", "medium", 2) ] },
                { name: "Mastery", weekStart: 6, weekEnd: 7, description: "Integrate advanced concepts and timed accuracy.", modules: [ module("Language Proficiency", "Sentence Structure", "Parallelism and Precision", "medium", 2), module("Mathematics", "Trigonometry", "Trigonometry Essentials", "hard", 3), module("Science", "Newton's Laws", "Physics Problem Solving", "hard", 3), module("Reading Comprehension", "Argument Analysis", "Argument Evaluation", "medium", 2) ] },
                { name: "Review & Mock Prep", weekStart: 8, weekEnd: 8, description: "Final consolidation and exam-readiness checks.", modules: [ module("Language Proficiency", "Grammar", "Language Final Review", "medium", 2), module("Mathematics", "Quadratic Equations", "Math Final Review", "hard", 2), module("Science", "Chemical Bonding", "Science Final Review", "medium", 2), module("Reading Comprehension", "Argument Analysis", "Reading Final Review", "medium", 2) ],
script
}, ],
}, ],
adaptationRules: {
