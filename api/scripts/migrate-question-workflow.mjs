    ...
    try {
        ...
        while (await cursor.hasNext()) {
            ...
            const update = {
                ...
                dedupFingerprint:
                    existing.dedupFingerprint || fingerprint(existing),
                contentBlocks: Array.isArray(existing.contentBlocks)
                    ? existing.contentBlocks
                    : [],
                mediaAssetIds: Array.isArray(existing.mediaAssetIds)
                    ? existing.mediaAssetIds
                    : [],
            };
