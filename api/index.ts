 ...
 *
 * This serves as the entry point for Cloudflare Workers and Pages Functions,
 * bridging the existing Express-based API to the Cloudflare runtime environment.
 */
