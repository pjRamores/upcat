 ...
 *
 * Centralizes VAPID configuration, payload signing, error handling, and auto-pruning of dead subscriptions. All push-sending code paths (subscribe-test, admin broadcast, cron jobs) go through `sendPush`.
 */
import { Db, ObjectId } from "mongodb";
import { PushSubscription, WebPushError } from "web-push";
import { PushNotificationPayload, PushPreferences, PushSubscriptionRecord } from "@upcat/shared";
