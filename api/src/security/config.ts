 ...
 * that controls every tunable in the security pipeline. We load it once per cold start and refresh in-process every 60 seconds — admins can update via `PUT /api/admin/security/config` without redeploying.
 */
