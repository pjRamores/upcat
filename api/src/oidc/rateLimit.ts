 ...
 *
 * Survives across warm serverless invocations on the same instance and
 * resets on cold starts. Good enough to protect the social-login endpoints
 * from naive abuse. A real distributed limiter (Redis/Upstash) can replace
