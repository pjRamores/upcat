 ...
 *
 * Provider clientId / secret / redirectUri / scopes are stored at runtime in
 * the auth_provider_settings collection — these constants only describe
 * the IdP endpoints and capabilities.
 */
...
export const PROVIDER_ENDPOINTS: Record<SocialProvider, ProviderEndpoints> = {
  ...
  facebook: {
    ...
    userinfoEndpoint:
      "https://graph.facebook.com/me?fields=id,email,name,first_name,last_name,picture.type(large)",
