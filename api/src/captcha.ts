 ...
 *
 * We sign a short-lived token (HMAC) containing the expected answer; the client returns both the token and the user's typed answer. We never need server-side session storage.
 */
