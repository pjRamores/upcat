...
const doc = await targetDb.collection<MonitoringConfig>("monitoring_config").findOne({_id: "global"});
cachedConfig = deepMerge<MonitoringConfig>(DEFAULT_MONITORING_CONFIG, doc??undefined);
cachedAt = now;
return cachedConfig as MonitoringConfig;
}
