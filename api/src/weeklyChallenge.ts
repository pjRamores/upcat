 ...
 *
 * Called from any "earns progress" entry point (exam/submit, practice/complete).
 * Translates a generic event into the relevant metric, increments the user's progress counter, and flips the challenge to completed when target is met.
