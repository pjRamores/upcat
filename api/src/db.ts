 ...
 *
 * Caches the MongoClient and Db across warm invocations to avoid the overhead of opening a new connection on every request. Uses a shared connection promise so concurrent cold-start requests share a single connect() call.
 */
