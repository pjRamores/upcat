  ...
  return `
    <div style="font-family:-apple-system,Segoe UI,sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#ffffff">
      ...
      <p style="color:#94a3b8;font-size:12px;margin-top:32px">
        UPCAT Simulator À· automated message â€” please do not reply directly.
      </p>
    </div>
  `;
}
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px">
        ...
        <p style="text-align:center;margin:32px 0">
          <a href="${verifyUrl}"
            style="background:#4f46e5;color:#fff;padding:12px 32px;border-radius:8px;text-decoration:none;font-weight:600">
            Verify Email
          </a>
        </p>
  ...
  await safeSend({
    ...
    html: panel(
      ...
      <p style="text-align:center;margin:24px 0">
        <a href="${args.downloadUrl}" style="background:#4f46e5;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600">Download my data</a>
      </p>
...
export async function sendDeletionRequestedEmail(
  ...
  await safeSend({
    ...
    html: panel(
      ...
      <p style="color:#334155">After confirming, your account will be permanently deleted on <strong>{args.scheduledFor.toUTCString()}</strong>.</p>
      <p style="text-align:center;margin:24px 0">
        You can cancel any time before that date by signing in.</p>
...
<p style="color:#334155">Your account is scheduled for permanent deletion on <strong>{scheduledFor.toUTCString()}</strong>.
You can cancel any time before that date by signing in and going to Settings → Data &amp; Privacy.</p>`,
});
});
}
...
subject,
html: panel(
  `<h2 style="color:#0f172a;margin:0 0 12px">${escape(subject)}</h2>
...
<p style="color:#334155">Submission: <strong>${escape(args.submissionNumber)}</strong></p>
