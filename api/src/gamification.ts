  ...
  if (existing && typeof existing.xp === "number") {
    ...
    const block: UserGamificationBlock = {
      ...
      achievements: {
        ...
        progress: existing.achievements?.progress && typeof existing.achievements.progress === "object"
      ...
      weeklyChallenge: existing.weeklyChallenge === undefined
...
export async function awardXp(
  ...
  return {
    ...
    newXp,
    previousLevel,
    levelUp: lvl.level > previousLevel,
    newTitle: lvl.title,
  };
}
