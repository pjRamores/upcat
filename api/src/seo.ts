/**
 * Server-side SEO helpers: sitemap XML generation, robots.txt, ads.txt rendering, and accessors for the seo_overrides + url_redirects collections.
 */
...
export async function upsertSeoOverride(
    db: Db,
    override: Omit<SeoOverride, "updatedAt"> & { updatedAt?: string | null },
): Promise<SeoOverride> {
