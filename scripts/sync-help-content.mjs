 ...
 *
 * Download published help content from the admin API and save it as a static asset.
 * This is called during the build process to generate a snapshot of help content that is bundled with the app.
 *
 * Usage:
...
async function syncHelpContent() {
    try {
        ...
        console.error(`Failed to sync help content:`, error instanceof Error ? error.message : error);
